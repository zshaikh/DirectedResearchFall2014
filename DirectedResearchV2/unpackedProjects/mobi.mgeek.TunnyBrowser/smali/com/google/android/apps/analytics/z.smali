.class Lcom/google/android/apps/analytics/z;
...
.field b:Lcom/google/android/apps/analytics/aa;
...
.method public constructor <init>(Lorg/apache/http/HttpHost;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/google/android/apps/analytics/z;-><init>(Lorg/apache/http/HttpHost;Lorg/apache/http/conn/scheme/SocketFactory;)V
...
.method public constructor <init>(Lorg/apache/http/HttpHost;Lorg/apache/http/conn/scheme/SocketFactory;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/analytics/z;->a:Lorg/apache/http/impl/DefaultHttpClientConnection;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/google/android/apps/analytics/z;->d:Z

    iput-object p1, p0, Lcom/google/android/apps/analytics/z;->e:Lorg/apache/http/HttpHost;

    iput-object p2, p0, Lcom/google/android/apps/analytics/z;->f:Lorg/apache/http/conn/scheme/SocketFactory;
...
.method private c()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/analytics/z;->a:Lorg/apache/http/impl/DefaultHttpClientConnection;
    ...
    iget-object v0, p0, Lcom/google/android/apps/analytics/z;->f:Lorg/apache/http/conn/scheme/SocketFactory;
    ...
    iget-object v2, p0, Lcom/google/android/apps/analytics/z;->e:Lorg/apache/http/HttpHost;

    invoke-virtual {v2}, Lorg/apache/http/HttpHost;->getHostName()Ljava/lang/String;

    move-result-object v2

    iget-object v3, p0, Lcom/google/android/apps/analytics/z;->e:Lorg/apache/http/HttpHost;
    ...
    iget-object v1, p0, Lcom/google/android/apps/analytics/z;->a:Lorg/apache/http/impl/DefaultHttpClientConnection;
...
.method public a()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/analytics/z;->b:Lcom/google/android/apps/analytics/aa;

    invoke-interface {v0, v1}, Lcom/google/android/apps/analytics/aa;->a(Z)V

    iput-boolean v1, p0, Lcom/google/android/apps/analytics/z;->d:Z
    ...
    iget-object v6, p0, Lcom/google/android/apps/analytics/z;->b:Lcom/google/android/apps/analytics/aa;

    invoke-interface {v6, v1}, Lcom/google/android/apps/analytics/aa;->a(Z)V
    ...
    iput v0, p0, Lcom/google/android/apps/analytics/z;->c:I
    ...
    iget v1, p0, Lcom/google/android/apps/analytics/z;->c:I

    invoke-interface {v0, v1}, Lcom/google/android/apps/analytics/aa;->a(I)V

    invoke-direct {p0}, Lcom/google/android/apps/analytics/z;->d()V
    ...
    invoke-interface {v0}, Lcom/google/android/apps/analytics/aa;->a()V
    ...
    :cond_6
    iget-boolean v0, p0, Lcom/google/android/apps/analytics/z;->d:Z
...
.method public a(Lcom/google/android/apps/analytics/aa;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/apps/analytics/z;->b:Lcom/google/android/apps/analytics/aa;
...
.method public a(Lorg/apache/http/HttpEntityEnclosingRequest;)V
    ...
    invoke-direct {p0}, Lcom/google/android/apps/analytics/z;->c()V
