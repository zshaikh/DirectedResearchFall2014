...
# direct methods
.method constructor <init>(Lretrofit/RestAdapter$RestHandler;Lretrofit/Callback;Ljava/util/concurrent/Executor;Lretrofit/RequestInterceptorTape;Lretrofit/RestMethodInfo;[Ljava/lang/Object;)V
    .locals 0
    ...
    iput-object p4, p0, Lretrofit/RestAdapter$RestHandler$2;->val$interceptorTape:Lretrofit/RequestInterceptorTape;

    iput-object p5, p0, Lretrofit/RestAdapter$RestHandler$2;->val$methodInfo:Lretrofit/RestMethodInfo;

    iput-object p6, p0, Lretrofit/RestAdapter$RestHandler$2;->val$args:[Ljava/lang/Object;

    invoke-direct {p0, p2, p3}, Lretrofit/CallbackRunnable;-><init>(Lretrofit/Callback;Ljava/util/concurrent/Executor;)V
