...
.method public getTreeCellRendererComponent(Ljavax/swing/JTree;Ljava/lang/Object;ZZZIZ)Ljava/awt/Component;
    ...
    invoke-virtual {v3, v4}, Ljavax/swing/JComponent;->setVisible(Z)V

    .line 109
    :goto_0
    invoke-virtual {p0, v1}, Lorg/apache/log4j/lf5/viewer/categoryexplorer/CategoryNodeRenderer;->buildToolTip(Lorg/apache/log4j/lf5/viewer/categoryexplorer/CategoryNode;)Ljava/lang/String;

    move-result-object v2

    .line 110
    .local v2, "toolTip":Ljava/lang/String;
    iget-object v3, p0, Lorg/apache/log4j/lf5/viewer/categoryexplorer/CategoryNodeRenderer;->_panel:Ljavax/swing/JPanel;

    invoke-virtual {v3, v2}, Ljavax/swing/JComponent;->setToolTipText(Ljava/lang/String;)V

    .line 111
    invoke-virtual {v1}, Lorg/apache/log4j/lf5/viewer/categoryexplorer/CategoryNode;->hasFatalChildren()Z
    ...
    .line 112
    sget-object v3, Lorg/apache/log4j/lf5/viewer/categoryexplorer/CategoryNodeRenderer;->FATAL_CHILDREN:Ljava/awt/Color;

    invoke-virtual {p0, v3}, Ljavax/swing/JComponent;->setForeground(Ljava/awt/Color;)V

    .line 114
    :cond_0
    invoke-virtual {v1}, Lorg/apache/log4j/lf5/viewer/categoryexplorer/CategoryNode;->hasFatalRecords()Z
    ...
    .line 106
    .end local v2    # "toolTip":Ljava/lang/String;
    :cond_2
    iget-object v3, p0, Lorg/apache/log4j/lf5/viewer/categoryexplorer/CategoryNodeRenderer;->_checkBox:Ljavax/swing/JCheckBox;
    ...
    invoke-virtual {v3, v4}, Ljavax/swing/AbstractButton;->setSelected(Z)V
