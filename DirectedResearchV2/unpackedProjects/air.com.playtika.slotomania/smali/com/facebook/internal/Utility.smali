...
.method public static queryAppAttributionSupportAndWait(Ljava/lang/String;)Z
    ...
    .line 305
    sget-object v6, Lcom/facebook/internal/Utility;->LOCK:Ljava/lang/Object;

    monitor-enter v6

    .line 308
    :try_start_0
    sget-object v5, Lcom/facebook/internal/Utility;->lastAppCheckedForAttributionStatus:Ljava/lang/String;
    ...
    .line 309
    sget-boolean v5, Lcom/facebook/internal/Utility;->attributionAllowedForLastAppChecked:Z
    ...
    .line 313
    .local v4, "supportsAttributionParams":Landroid/os/Bundle;
    ...
    invoke-static {v5, p0, v7}, Lcom/facebook/Request;->newGraphPathRequest(Lcom/facebook/Session;Ljava/lang/String;Lcom/facebook/Request$Callback;)Lcom/facebook/Request;

    move-result-object v2

    .line 315
    .local v2, "pingRequest":Lcom/facebook/Request;
    invoke-virtual {v2, v4}, Lcom/facebook/Request;->setParameters(Landroid/os/Bundle;)V
    ...
    .line 320
    .local v1, "doesSupportAttribution":Ljava/lang/Boolean;
    if-eqz v3, :cond_1

    .line 321
    const-string v5, "supports_attribution"

    invoke-interface {v3, v5}, Lcom/facebook/model/GraphObject;->getProperty(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v1

    .line 324
    .end local v1    # "doesSupportAttribution":Ljava/lang/Boolean;
    :cond_1
    ...
    .restart local v1    # "doesSupportAttribution":Ljava/lang/Boolean;
    move-object v5, v1
    ...
    sput-boolean v5, Lcom/facebook/internal/Utility;->attributionAllowedForLastAppChecked:Z
    ...
    .line 305
    .end local v2    # "pingRequest":Lcom/facebook/Request;
    .end local v3    # "supportResponse":Lcom/facebook/model/GraphObject;
    .end local v4    # "supportsAttributionParams":Landroid/os/Bundle;
    :catchall_0
    move-exception v5
    ...
    .restart local v2    # "pingRequest":Lcom/facebook/Request;
    .restart local v3    # "supportResponse":Lcom/facebook/model/GraphObject;
    .restart local v4    # "supportsAttributionParams":Landroid/os/Bundle;
    .restart local p0    # "applicationId":Ljava/lang/String;
    :cond_2
    move-object v5, v1
