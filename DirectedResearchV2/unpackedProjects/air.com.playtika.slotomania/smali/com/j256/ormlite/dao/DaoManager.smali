...
.method public static declared-synchronized addCachedDatabaseConfigs(Ljava/util/Collection;)V
    ...
    :try_start_0
    sget-object v4, Lcom/j256/ormlite/dao/DaoManager;->configMap:Ljava/util/Map;
...
.method public static declared-synchronized createDao(Lcom/j256/ormlite/support/ConnectionSource;Ljava/lang/Class;)Lcom/j256/ormlite/dao/Dao;
    ...
    .line 47
    .local v0, "key":Lcom/j256/ormlite/dao/DaoManager$ClassConnectionSource;
    ...
    .local p0, "castDao":Lcom/j256/ormlite/dao/Dao;, "TD;"
    move-object p1, v0
    ...
    .line 55
    .restart local v0    # "dao":Lcom/j256/ormlite/dao/Dao;, "Lcom/j256/ormlite/dao/Dao<**>;"
    .local p0, "connectionSource":Lcom/j256/ormlite/support/ConnectionSource;
    .local p1, "clazz":Ljava/lang/Class;, "Ljava/lang/Class<TT;>;"
    :cond_1
    :try_start_2
    ...
    .line 59
    .end local v1    # "dao":Lcom/j256/ormlite/dao/Dao;, "Lcom/j256/ormlite/dao/Dao<**>;"
    .local p1, "dao":Lcom/j256/ormlite/dao/Dao;, "Lcom/j256/ormlite/dao/Dao<**>;"
    goto :goto_0

    .line 62
    .restart local v1    # "dao":Lcom/j256/ormlite/dao/Dao;, "Lcom/j256/ormlite/dao/Dao<**>;"
    .local p0, "connectionSource":Lcom/j256/ormlite/support/ConnectionSource;
    .local p1, "clazz":Ljava/lang/Class;, "Ljava/lang/Class<TT;>;"
    :cond_2
    ...
    .line 74
    .local v0, "daoTmp":Lcom/j256/ormlite/dao/Dao;, "Lcom/j256/ormlite/dao/Dao<TT;*>;"
    :goto_1
    move-object v0, v0
    ...
    const-string v2, "created dao for class {} with reflection"

    invoke-virtual {v1, v2, p1}, Lcom/j256/ormlite/logger/Logger;->debug(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .local p1, "dao":Lcom/j256/ormlite/dao/Dao;, "Lcom/j256/ormlite/dao/Dao<**>;"
    :goto_2
    invoke-static {p0, p1}, Lcom/j256/ormlite/dao/DaoManager;->registerDao(Lcom/j256/ormlite/support/ConnectionSource;Lcom/j256/ormlite/dao/Dao;)V
    ...
    .line 78
    .local v2, "daoClass":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    const/4 v0, 0x2

    new-array v0, v0, [Ljava/lang/Object;

    .end local v0    # "databaseTable":Lcom/j256/ormlite/table/DatabaseTable;
    const/4 v3, 0x0
    ...
    invoke-static {v2, v0}, Lcom/j256/ormlite/dao/DaoManager;->findConstructor(Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/reflect/Constructor;

    move-result-object v3

    .line 81
    .local v3, "daoConstructor":Ljava/lang/reflect/Constructor;, "Ljava/lang/reflect/Constructor<*>;"
    if-nez v3, :cond_6
    ...
    .line 84
    .end local v3    # "daoConstructor":Ljava/lang/reflect/Constructor;, "Ljava/lang/reflect/Constructor<*>;"
    ...
    .line 85
    .restart local v3    # "daoConstructor":Ljava/lang/reflect/Constructor;, "Ljava/lang/reflect/Constructor<*>;"
    if-nez v3, :cond_6
    ...
    const-string v3, "created dao for class {} from constructor"
    ...
    .end local p0    # "dao":Lcom/j256/ormlite/dao/Dao;, "Lcom/j256/ormlite/dao/Dao<**>;"
