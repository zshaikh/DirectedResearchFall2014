...
.method private rebuildSections()V
    ...
    iput-object v6, p0, Lcom/facebook/widget/GraphObjectAdapter;->sectionKeys:Ljava/util/List;
    ...
    iput-object v6, p0, Lcom/facebook/widget/GraphObjectAdapter;->graphObjectsBySection:Ljava/util/Map;
    ...
    iput-object v6, p0, Lcom/facebook/widget/GraphObjectAdapter;->graphObjectsById:Ljava/util/Map;

    .line 452
    iput-boolean v9, p0, Lcom/facebook/widget/GraphObjectAdapter;->displaySections:Z
    ...
    invoke-interface {v6}, Lcom/facebook/widget/GraphObjectCursor;->getCount()I
    ...
    invoke-interface {v6}, Lcom/facebook/widget/GraphObjectCursor;->moveToFirst()Z

    .line 461
    :cond_2
    iget-object v6, p0, Lcom/facebook/widget/GraphObjectAdapter;->cursor:Lcom/facebook/widget/GraphObjectCursor;

    invoke-interface {v6}, Lcom/facebook/widget/GraphObjectCursor;->getGraphObject()Lcom/facebook/model/GraphObject;
    ...
    invoke-interface {v6}, Lcom/facebook/widget/GraphObjectCursor;->moveToNext()Z
    ...
    .line 480
    iget-object v6, p0, Lcom/facebook/widget/GraphObjectAdapter;->sortFields:Ljava/util/List;
    ...
    .line 477
    iget-object v6, p0, Lcom/facebook/widget/GraphObjectAdapter;->graphObjectsById:Ljava/util/Map;
...
.method protected getPictureUriOfGraphObject(Lcom/facebook/model/GraphObject;)Ljava/net/URI;
    ...
    .line 269
    .local v2, "itemPicture":Lcom/facebook/widget/GraphObjectAdapter$ItemPicture;
    ...
    .line 270
    .local v1, "data":Lcom/facebook/widget/GraphObjectAdapter$ItemPictureData;
    if-eqz v1, :cond_0
    ...
    .line 278
    .end local v1    # "data":Lcom/facebook/widget/GraphObjectAdapter$ItemPictureData;
    .end local v2    # "itemPicture":Lcom/facebook/widget/GraphObjectAdapter$ItemPicture;
    :catch_0
    move-exception v5
...
.method getSectionAndItem(I)Lcom/facebook/widget/GraphObjectAdapter$SectionAndItem;
    ...
    invoke-direct {v6, v8, v8}, Lcom/facebook/widget/GraphObjectAdapter$SectionAndItem;-><init>(Ljava/lang/String;Lcom/facebook/model/GraphObject;)V
...
.method public prioritizeViewRange(III)V
    ...
    iget-object v0, v0, Lcom/facebook/widget/GraphObjectAdapter;->sectionKeys:Ljava/util/List;
    ...
    invoke-virtual {v0, v1}, Lcom/facebook/widget/GraphObjectAdapter;->getSectionAndItem(I)Lcom/facebook/widget/GraphObjectAdapter$SectionAndItem;

    move-result-object v12

    .line 198
    .local v12, "sectionAndItem":Lcom/facebook/widget/GraphObjectAdapter$SectionAndItem;, "Lcom/facebook/widget/GraphObjectAdapter$SectionAndItem<TT;>;"
    iget-object v15, v12, Lcom/facebook/widget/GraphObjectAdapter$SectionAndItem;->graphObject:Lcom/facebook/model/GraphObject;
    ...
    invoke-virtual {v0, v1}, Lcom/facebook/widget/GraphObjectAdapter;->getIdOfGraphObject(Lcom/facebook/model/GraphObject;)Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/facebook/widget/GraphObjectAdapter;->pendingRequests:Ljava/util/Map;
    ...
    check-cast v11, Lcom/facebook/internal/ImageRequest;

    .line 201
    .local v11, "request":Lcom/facebook/internal/ImageRequest;
    if-eqz v11, :cond_2

    .line 202
    invoke-static {v11}, Lcom/facebook/internal/ImageDownloader;->prioritizeRequest(Lcom/facebook/internal/ImageRequest;)V

    .line 196
    .end local v10    # "id":Ljava/lang/String;
    .end local v11    # "request":Lcom/facebook/internal/ImageRequest;
    :cond_2
    ...
    .line 209
    .end local v12    # "sectionAndItem":Lcom/facebook/widget/GraphObjectAdapter$SectionAndItem;, "Lcom/facebook/widget/GraphObjectAdapter$SectionAndItem<TT;>;"
    :cond_3
    const/4 v15, 0x0
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/facebook/widget/GraphObjectAdapter;->getCount()I
    ...
    .line 213
    .local v7, "graphObjectsToPrefetchPicturesFor":Ljava/util/ArrayList;, "Ljava/util/ArrayList<TT;>;"
    move v8, v13
    ...
    .line 215
    .restart local v12    # "sectionAndItem":Lcom/facebook/widget/GraphObjectAdapter$SectionAndItem;, "Lcom/facebook/widget/GraphObjectAdapter$SectionAndItem<TT;>;"
    iget-object v15, v12, Lcom/facebook/widget/GraphObjectAdapter$SectionAndItem;->graphObject:Lcom/facebook/model/GraphObject;
    ...
    .line 226
    .local v6, "graphObject":Lcom/facebook/model/GraphObject;, "TT;"
    move-object/from16 v0, p0

    move-object v1, v6

    invoke-virtual {v0, v1}, Lcom/facebook/widget/GraphObjectAdapter;->getPictureUriOfGraphObject(Lcom/facebook/model/GraphObject;)Ljava/net/URI;
    ...
    iget-object v0, v0, Lcom/facebook/widget/GraphObjectAdapter;->prefetchedProfilePictureIds:Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/facebook/widget/GraphObjectAdapter;->downloadProfilePicture(Ljava/lang/String;Ljava/net/URI;Landroid/widget/ImageView;)V
