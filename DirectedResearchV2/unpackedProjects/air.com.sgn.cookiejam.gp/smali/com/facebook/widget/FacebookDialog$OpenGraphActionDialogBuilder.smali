...
.method public setImageAttachmentsForAction(Ljava/util/List;Z)Lcom/facebook/widget/FacebookDialog$OpenGraphActionDialogBuilder;
    ...
    invoke-static {p1, v6}, Lcom/facebook/internal/Validate;->containsNoNulls(Ljava/util/Collection;Ljava/lang/String;)V
    ...
    const-string v7, "Unable to attach images"

    invoke-direct {v6, v7, v2}, Lcom/facebook/FacebookException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v6, v1}, Lcom/facebook/model/OpenGraphAction;->setImage(Ljava/util/List;)V
    ...
    invoke-interface {v6, v0}, Lcom/facebook/model/OpenGraphAction;->setImageUrls(Ljava/util/List;)V
...
.method public setImageAttachmentsForObject(Ljava/lang/String;Ljava/util/List;Z)Lcom/facebook/widget/FacebookDialog$OpenGraphActionDialogBuilder;
    ...
    .line 680
    .local p2, "bitmaps":Ljava/util/List;, "Ljava/util/List<Landroid/graphics/Bitmap;>;"
    const-string v7, "objectProperty"

    invoke-static {p1, v7}, Lcom/facebook/internal/Validate;->notNull(Ljava/lang/Object;Ljava/lang/String;)V

    .line 681
    const-string v7, "bitmaps"

    invoke-static {p2, v7}, Lcom/facebook/internal/Validate;->containsNoNulls(Ljava/util/Collection;Ljava/lang/String;)V

    .line 682
    iget-object v7, p0, Lcom/facebook/widget/FacebookDialog$OpenGraphActionDialogBuilder;->action:Lcom/facebook/model/OpenGraphAction;
    ...
    const-string v8, "Can not set attachments prior to setting action."
    ...
    const-class v8, Lcom/facebook/model/OpenGraphObject;

    invoke-interface {v7, p1, v8}, Lcom/facebook/model/OpenGraphAction;->getPropertyAs(Ljava/lang/String;Ljava/lang/Class;)Lcom/facebook/model/GraphObject;

    move-result-object v5

    check-cast v5, Lcom/facebook/model/OpenGraphObject;

    .line 689
    .local v5, "object":Lcom/facebook/model/OpenGraphObject;
    if-nez v5, :cond_1
    ...
    const-string v9, "Action does not contain a property"
    ...
    .line 692
    .end local v5    # "object":Lcom/facebook/model/OpenGraphObject;
    :catch_0
    move-exception v7
    ...
    const-string v9, " is not a graph object."
    ...
    .restart local v5    # "object":Lcom/facebook/model/OpenGraphObject;
    :cond_1
    ...
    invoke-static {v7}, Lcom/facebook/model/GraphObject$Factory;->createList(Ljava/lang/Class;)Lcom/facebook/model/GraphObjectList;
    ...
    invoke-interface {v3, v7, v6}, Lcom/facebook/model/GraphObject;->setProperty(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    :cond_2
    invoke-interface {v5, v1}, Lcom/facebook/model/OpenGraphObject;->setImage(Lcom/facebook/model/GraphObjectList;)V
    ...
    .line 708
    :cond_3
    invoke-interface {v5, v0}, Lcom/facebook/model/OpenGraphObject;->setImageUrls(Ljava/util/List;)V
