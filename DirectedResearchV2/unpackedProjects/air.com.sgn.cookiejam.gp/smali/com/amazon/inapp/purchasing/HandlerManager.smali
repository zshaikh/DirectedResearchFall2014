...
.field private static volatile HANDLER_ADAPTERS:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "<",
            "Ljava/lang/String;",
            "Lcom/amazon/inapp/purchasing/HandlerAdapter;",
            ">;"
        }
    .end annotation
.end field
...
.method static getHandlerAdapter(Ljava/lang/String;)Lcom/amazon/inapp/purchasing/HandlerAdapter;
    ...
    const-class v0, Lcom/amazon/inapp/purchasing/HandlerManager;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/amazon/inapp/purchasing/HandlerManager;->HANDLER_ADAPTERS:Ljava/util/Map;
    ...
    new-instance v1, Lcom/amazon/inapp/purchasing/HandlerAdapter;

    invoke-direct {v1, v2}, Lcom/amazon/inapp/purchasing/HandlerAdapter;-><init>(Landroid/os/Handler;)V
    ...
    check-cast p0, Lcom/amazon/inapp/purchasing/HandlerAdapter;
...
.method static getMainHandlerAdapter()Lcom/amazon/inapp/purchasing/HandlerAdapter;
    ...
    :try_start_0
    sget-object v1, Lcom/amazon/inapp/purchasing/HandlerManager;->MAIN_HANDLER_ADAPTER:Lcom/amazon/inapp/purchasing/HandlerAdapter;
    ...
    invoke-direct {v2, v1}, Lcom/amazon/inapp/purchasing/HandlerAdapter;-><init>(Landroid/os/Handler;)V
