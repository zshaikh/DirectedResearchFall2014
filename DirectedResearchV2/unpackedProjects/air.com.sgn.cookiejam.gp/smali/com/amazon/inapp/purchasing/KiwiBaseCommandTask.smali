...
.method protected getSubscriptionPeriodFromReceiptJson(Lorg/json/JSONObject;)Lcom/amazon/inapp/purchasing/SubscriptionPeriod;
    ...
    invoke-virtual {p0, v0}, Lcom/amazon/inapp/purchasing/KiwiBaseCommandTask;->getDateFromString(Ljava/lang/String;)Ljava/util/Date;
    ...
    :goto_1
    new-instance v2, Lcom/amazon/inapp/purchasing/SubscriptionPeriod;

    invoke-direct {v2, v0, v1}, Lcom/amazon/inapp/purchasing/SubscriptionPeriod;-><init>(Ljava/util/Date;Ljava/util/Date;)V
...
.method protected onFailure(Lcom/amazon/venezia/command/FailureResult;)V
    ...
    const-string v0, "onFailure: null result"
    ...
    const-string v1, "onFailure: result message: "
...
.method protected verifyReceipt(Ljava/lang/String;Lcom/amazon/inapp/purchasing/Receipt;Lorg/json/JSONObject;)Z
    ...
    const-string v3, "KiwiBaseCommandTask"
    ...
    const-string v1, "Validating receipt: "
    ...
    invoke-virtual {p0, v0}, Lcom/amazon/inapp/purchasing/KiwiBaseCommandTask;->isNullOrEmpty(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1, v1, v0}, Lcom/amazon/inapp/purchasing/KiwiBaseCommandTask;->verifySignature(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v2, "signature verification "
    ...
    const-string v2, " for request ID "
    ...
    invoke-static {v3, v1}, Lcom/amazon/inapp/purchasing/Logger;->error(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, "a signature was not found in the receipt for request ID "
