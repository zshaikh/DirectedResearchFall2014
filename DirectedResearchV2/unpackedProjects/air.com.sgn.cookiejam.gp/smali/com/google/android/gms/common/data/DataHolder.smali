...
.method private static a(Landroid/database/AbstractWindowedCursor;)[Landroid/database/CursorWindow;
    ...
    invoke-virtual {p0, v3}, Landroid/database/AbstractWindowedCursor;->setWindow(Landroid/database/CursorWindow;)V
    ...
    invoke-virtual {p0, v2}, Landroid/database/AbstractWindowedCursor;->moveToPosition(I)Z
    ...
    invoke-virtual {p0, v2, v3}, Landroid/database/AbstractWindowedCursor;->fillWindow(ILandroid/database/CursorWindow;)V
...
.method private static a(Lcom/google/android/gms/common/data/DataHolder$Builder;I)[Landroid/database/CursorWindow;
    ...
    new-array v0, v11, [Landroid/database/CursorWindow;
    ...
    invoke-direct {v0, v11}, Landroid/database/CursorWindow;-><init>(Z)V
    ...
    const-string v2, "Unable to allocate row to hold data."
    ...
    invoke-virtual {v0, v11, p1}, Ljava/util/ArrayList;->subList(II)Ljava/util/List;
    ...
    invoke-virtual {v7, v6, v8}, Landroid/database/CursorWindow;->putNull(II)Z
    ...
    invoke-virtual {v7, v1, v6, v8}, Landroid/database/CursorWindow;->putString(Ljava/lang/String;II)Z
    ...
    invoke-virtual {v7, v9, v10, v6, v8}, Landroid/database/CursorWindow;->putLong(JII)Z
    ...
    invoke-virtual {v7, v1, v6, v8}, Landroid/database/CursorWindow;->putBlob([BII)Z
    ...
    invoke-virtual {p0}, Landroid/database/CursorWindow;->close()V
...
.method public C(I)I
    ...
    :goto_1
    iget-object v1, p0, Lcom/google/android/gms/common/data/DataHolder;->nO:[I
...
.method public validateContents()V
    ...
    :goto_0
    iget-object v1, p0, Lcom/google/android/gms/common/data/DataHolder;->nK:[Ljava/lang/String;
    ...
    :cond_1
    iput v1, p0, Lcom/google/android/gms/common/data/DataHolder;->nP:I
