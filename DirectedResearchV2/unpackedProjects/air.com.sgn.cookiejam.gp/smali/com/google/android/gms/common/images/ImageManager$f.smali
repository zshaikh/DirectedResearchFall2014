...
.method public constructor <init>(Lcom/google/android/gms/common/images/ImageManager;Landroid/net/Uri;Landroid/graphics/Bitmap;ZLjava/util/concurrent/CountDownLatch;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/images/ImageManager$f;->ol:Lcom/google/android/gms/common/images/ImageManager;
    ...
    iput-boolean p4, p0, Lcom/google/android/gms/common/images/ImageManager$f;->oo:Z

    iput-object p5, p0, Lcom/google/android/gms/common/images/ImageManager$f;->mX:Ljava/util/concurrent/CountDownLatch;
...
.method private a(Lcom/google/android/gms/common/images/ImageManager$ImageReceiver;Z)V
    ...
    iput-boolean v7, p1, Lcom/google/android/gms/common/images/ImageManager$ImageReceiver;->ok:Z
    ...
    iget-object v4, p0, Lcom/google/android/gms/common/images/ImageManager$f;->ol:Lcom/google/android/gms/common/images/ImageManager;

    invoke-static {v4}, Lcom/google/android/gms/common/images/ImageManager;->a(Lcom/google/android/gms/common/images/ImageManager;)Landroid/content/Context;
    ...
    :goto_1
    iget v4, v0, Lcom/google/android/gms/common/images/a;->os:I

    if-eq v4, v7, :cond_0

    iget-object v4, p0, Lcom/google/android/gms/common/images/ImageManager$f;->ol:Lcom/google/android/gms/common/images/ImageManager;

    invoke-static {v4}, Lcom/google/android/gms/common/images/ImageManager;->c(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/Map;
    ...
    invoke-virtual {v0, v4, v6}, Lcom/google/android/gms/common/images/a;->b(Landroid/content/Context;Z)V

    goto :goto_1

    :cond_2
    iput-boolean v6, p1, Lcom/google/android/gms/common/images/ImageManager$ImageReceiver;->ok:Z
...
.method public run()V
    ...
    :goto_0
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager$f;->ol:Lcom/google/android/gms/common/images/ImageManager;
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/common/images/ImageManager$f;->oo:Z
    ...
    iput-boolean v2, p0, Lcom/google/android/gms/common/images/ImageManager$f;->oo:Z
    ...
    :cond_3
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager$f;->mX:Ljava/util/concurrent/CountDownLatch;

    invoke-virtual {v0}, Ljava/util/concurrent/CountDownLatch;->countDown()V

    invoke-static {}, Lcom/google/android/gms/common/images/ImageManager;->aZ()Ljava/lang/Object;
    ...
    :try_start_0
    invoke-static {}, Lcom/google/android/gms/common/images/ImageManager;->bA()Ljava/util/HashSet;
