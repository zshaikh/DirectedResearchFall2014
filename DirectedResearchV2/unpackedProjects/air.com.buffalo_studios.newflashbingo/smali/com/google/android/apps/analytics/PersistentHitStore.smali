...
.field private static final CREATE_CUSTOM_VARIABLES_TABLE:Ljava/lang/String;

.field private static final CREATE_CUSTOM_VAR_VISITOR_CACHE_TABLE:Ljava/lang/String;
...
.field private static final CREATE_ITEM_EVENTS_TABLE:Ljava/lang/String;

.field private static final CREATE_OLD_CUSTOM_VAR_CACHE_TABLE:Ljava/lang/String;
...
.field private static final CREATE_SESSION_TABLE:Ljava/lang/String;

.field private static final CREATE_TRANSACTION_EVENTS_TABLE:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    const-string v8, " \'%s\' TEXT NOT NULL,"

    const-string v7, " \'%s\' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,"
...
.method static formatReferrer(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_1
    invoke-static {v0}, Lcom/google/android/apps/analytics/Utils;->parseURLParameters(Ljava/lang/String;)Ljava/util/Map;
...
.method private getAndUpdateReferrer(Landroid/database/sqlite/SQLiteDatabase;)Lcom/google/android/apps/analytics/Referrer;
    ...
    invoke-direct {p0, p1, v0}, Lcom/google/android/apps/analytics/PersistentHitStore;->setReferrerDatabase(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;)Z
...
.method private putEvent(Lcom/google/android/apps/analytics/Event;Landroid/database/sqlite/SQLiteDatabase;Z)V
    ...
    iget-object v1, p1, Lcom/google/android/apps/analytics/Event;->accountId:Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v0, p2, p3}, Lcom/google/android/apps/analytics/PersistentHitStore;->writeEventToDatabase(Lcom/google/android/apps/analytics/Event;Lcom/google/android/apps/analytics/Referrer;Landroid/database/sqlite/SQLiteDatabase;Z)V
    ...
    invoke-virtual {p0, v5, v0, p2, p3}, Lcom/google/android/apps/analytics/PersistentHitStore;->writeEventToDatabase(Lcom/google/android/apps/analytics/Event;Lcom/google/android/apps/analytics/Referrer;Landroid/database/sqlite/SQLiteDatabase;Z)V
...
.method public getNumStoredHitsFromDb()I
    ...
    const-string v1, "SELECT COUNT(*) from hits"
...
.method getTransaction(JLandroid/database/sqlite/SQLiteDatabase;)Lcom/google/android/apps/analytics/Transaction;
    ...
    new-instance v1, Lcom/google/android/apps/analytics/Transaction$Builder;
    ...
    invoke-direct {v1, v2, v3, v4}, Lcom/google/android/apps/analytics/Transaction$Builder;-><init>(Ljava/lang/String;D)V
    ...
    invoke-virtual {v1, v2}, Lcom/google/android/apps/analytics/Transaction$Builder;->setStoreName(Ljava/lang/String;)Lcom/google/android/apps/analytics/Transaction$Builder;
    ...
    invoke-virtual {v1, v2, v3}, Lcom/google/android/apps/analytics/Transaction$Builder;->setTotalTax(D)Lcom/google/android/apps/analytics/Transaction$Builder;
    ...
    invoke-virtual {v1, v2, v3}, Lcom/google/android/apps/analytics/Transaction$Builder;->setShippingCost(D)Lcom/google/android/apps/analytics/Transaction$Builder;

    move-result-object v1

    invoke-virtual {v1}, Lcom/google/android/apps/analytics/Transaction$Builder;->build()Lcom/google/android/apps/analytics/Transaction;
    :try_end_1
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_1 .. :try_end_1} :catch_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
...
.method public loadExistingSession(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    iput v1, p0, Lcom/google/android/apps/analytics/PersistentHitStore;->storeId:I
    ...
    :goto_0
    iput-boolean v1, p0, Lcom/google/android/apps/analytics/PersistentHitStore;->sessionStarted:Z
    :try_end_1
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_1 .. :try_end_1} :catch_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    iput-boolean v1, p0, Lcom/google/android/apps/analytics/PersistentHitStore;->useStoredVisitorVars:Z
...
.method public peekEvents(ILandroid/database/sqlite/SQLiteDatabase;I)[Lcom/google/android/apps/analytics/Event;
    ...
    const-string v6, "__##GOOGLEPAGEVIEW##__"
    ...
    :goto_1
    new-instance v4, Lcom/google/android/apps/analytics/Event;
    ...
    invoke-direct/range {v4 .. v19}, Lcom/google/android/apps/analytics/Event;-><init>(JLjava/lang/String;IIIIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;III)V
    ...
    invoke-virtual {v4, v5}, Lcom/google/android/apps/analytics/Event;->setUserId(I)V
    ...
    const-string v7, "__##GOOGLETRANSACTION##__"

    iget-object v8, v4, Lcom/google/android/apps/analytics/Event;->category:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/google/android/apps/analytics/PersistentHitStore;->getTransaction(JLandroid/database/sqlite/SQLiteDatabase;)Lcom/google/android/apps/analytics/Transaction;

    move-result-object v7

    if-nez v7, :cond_0

    const-string v8, "GoogleAnalyticsTracker"

    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "missing expected transaction for event "
    ...
    :cond_0
    invoke-virtual {v4, v7}, Lcom/google/android/apps/analytics/Event;->setTransaction(Lcom/google/android/apps/analytics/Transaction;)V
    ...
    new-array v4, v4, [Lcom/google/android/apps/analytics/Event;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_2
    ...
    :cond_2
    :try_start_3
    const-string v7, "__##GOOGLEITEM##__"
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/google/android/apps/analytics/PersistentHitStore;->getItem(JLandroid/database/sqlite/SQLiteDatabase;)Lcom/google/android/apps/analytics/Item;
    ...
    const-string v10, "missing expected item for event "
    ...
    :cond_3
    invoke-virtual {v4, v7}, Lcom/google/android/apps/analytics/Event;->setItem(Lcom/google/android/apps/analytics/Item;)V
    :try_end_3
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_3 .. :try_end_3} :catch_0
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/google/android/apps/analytics/PersistentHitStore;->getCustomVariables(JLandroid/database/sqlite/SQLiteDatabase;)Lcom/google/android/apps/analytics/CustomVariableBuffer;

    move-result-object v5

    :goto_6
    invoke-virtual {v4, v5}, Lcom/google/android/apps/analytics/Event;->setCustomVariableBuffer(Lcom/google/android/apps/analytics/CustomVariableBuffer;)V

    goto :goto_2

    :cond_6
    new-instance v5, Lcom/google/android/apps/analytics/CustomVariableBuffer;

    invoke-direct {v5}, Lcom/google/android/apps/analytics/CustomVariableBuffer;-><init>()V
    :try_end_4
...
.method public peekHits(I)[Lcom/google/android/apps/analytics/Hit;
    ...
    new-instance v1, Lcom/google/android/apps/analytics/Hit;
    ...
    invoke-direct {v1, v2, v3, v4}, Lcom/google/android/apps/analytics/Hit;-><init>(Ljava/lang/String;J)V
    ...
    check-cast p0, [Lcom/google/android/apps/analytics/Hit;
...
.method putCustomVariables(Lcom/google/android/apps/analytics/Event;Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string v9, "custom_var_visitor_cache"
    ...
    iget-boolean v1, p0, Lcom/google/android/apps/analytics/PersistentHitStore;->useStoredVisitorVars:Z
    ...
    iget-object v2, p0, Lcom/google/android/apps/analytics/PersistentHitStore;->visitorCVCache:Lcom/google/android/apps/analytics/CustomVariableBuffer;

    invoke-virtual {v2, v1}, Lcom/google/android/apps/analytics/CustomVariableBuffer;->getCustomVariableAt(I)Lcom/google/android/apps/analytics/CustomVariable;

    move-result-object v2

    invoke-virtual {v0, v1}, Lcom/google/android/apps/analytics/CustomVariableBuffer;->getCustomVariableAt(I)Lcom/google/android/apps/analytics/CustomVariable;
    ...
    invoke-virtual {v0, v2}, Lcom/google/android/apps/analytics/CustomVariableBuffer;->setCustomVariable(Lcom/google/android/apps/analytics/CustomVariable;)V
    ...
    :cond_4
    iput-boolean v7, p0, Lcom/google/android/apps/analytics/PersistentHitStore;->useStoredVisitorVars:Z
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/apps/analytics/CustomVariableBuffer;->isIndexAvailable(I)Z
    ...
    const-string v3, "custom_var_visitor_cache"
    ...
    invoke-virtual {p2, v9, v3, v4}, Landroid/database/sqlite/SQLiteDatabase;->delete(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-virtual {p2, v9, v4, v3}, Landroid/database/sqlite/SQLiteDatabase;->insert(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)J
    ...
    invoke-virtual {v3, v2}, Lcom/google/android/apps/analytics/CustomVariableBuffer;->setCustomVariable(Lcom/google/android/apps/analytics/CustomVariable;)V
    ...
    invoke-virtual {v3, v2}, Lcom/google/android/apps/analytics/CustomVariableBuffer;->clearCustomVariableAt(I)V
...
.method public putEvent(Lcom/google/android/apps/analytics/Event;)V
    ...
    const-string v0, "User has been sampled out. Aborting hit."
    ...
    iget-boolean v1, p0, Lcom/google/android/apps/analytics/PersistentHitStore;->sessionStarted:Z

    if-nez v1, :cond_4

    invoke-virtual {p0, v0}, Lcom/google/android/apps/analytics/PersistentHitStore;->storeUpdatedSession(Landroid/database/sqlite/SQLiteDatabase;)V

    :cond_4
    const/4 v1, 0x1

    invoke-direct {p0, p1, v0, v1}, Lcom/google/android/apps/analytics/PersistentHitStore;->putEvent(Lcom/google/android/apps/analytics/Event;Landroid/database/sqlite/SQLiteDatabase;Z)V
    ...
    invoke-static {v0}, Lcom/google/android/apps/analytics/PersistentHitStore;->endTransaction(Landroid/database/sqlite/SQLiteDatabase;)Z
...
.method public setReferrer(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v1}, Lcom/google/android/apps/analytics/PersistentHitStore;->readCurrentReferrer(Landroid/database/sqlite/SQLiteDatabase;)Lcom/google/android/apps/analytics/Referrer;
    ...
    invoke-virtual {v2}, Lcom/google/android/apps/analytics/Referrer;->getIndex()I

    move-result v0

    int-to-long v4, v0

    invoke-virtual {v2}, Lcom/google/android/apps/analytics/Referrer;->getTimeStamp()J
    ...
    invoke-direct {p0, v1, v3}, Lcom/google/android/apps/analytics/PersistentHitStore;->setReferrerDatabase(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/ContentValues;)Z
...
.method storeUpdatedSession(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-virtual {v0, v9, v5, v5}, Landroid/database/sqlite/SQLiteDatabase;->delete(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-virtual {v0, v9, v5, v1}, Landroid/database/sqlite/SQLiteDatabase;->insert(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)J
