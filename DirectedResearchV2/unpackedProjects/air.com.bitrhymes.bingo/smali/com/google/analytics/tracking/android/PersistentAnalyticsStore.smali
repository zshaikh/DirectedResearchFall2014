...
.method public static generateHitString(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/google/analytics/tracking/android/HitBuilder;->encode(Ljava/lang/String;)Ljava/lang/String;
...
.method public clearHits(J)V
    ...
    invoke-virtual {v0, v7, v6, v6}, Landroid/database/sqlite/SQLiteDatabase;->delete(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-virtual {v0, v7, v2, v1}, Landroid/database/sqlite/SQLiteDatabase;->delete(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
...
.method public deleteHits(Ljava/util/Collection;)V
    ...
    :goto_2
    invoke-interface {v8, v9}, Lcom/google/analytics/tracking/android/AnalyticsStoreStateListener;->reportStoreIsEmpty(Z)V
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method deleteStaleHits()I
    ...
    .line 408
    iget-object v6, p0, Lcom/google/analytics/tracking/android/PersistentAnalyticsStore;->mClock:Lcom/google/analytics/tracking/android/Clock;

    invoke-interface {v6}, Lcom/google/analytics/tracking/android/Clock;->currentTimeMillis()J
    ...
    .line 414
    const-string v6, "Error opening database for deleteStaleHits"

    invoke-direct {p0, v6}, Lcom/google/analytics/tracking/android/PersistentAnalyticsStore;->getWritableDatabase(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 420
    .local v5, "rslt":I
    iget-object v6, p0, Lcom/google/analytics/tracking/android/PersistentAnalyticsStore;->mListener:Lcom/google/analytics/tracking/android/AnalyticsStoreStateListener;
    ...
    :goto_1
    invoke-interface {v6, v7}, Lcom/google/analytics/tracking/android/AnalyticsStoreStateListener;->reportStoreIsEmpty(Z)V
...
.method public peekHits(I)Ljava/util/List;
    ...
    invoke-direct {v0, v1}, Lcom/google/analytics/tracking/android/PersistentAnalyticsStore;->getWritableDatabase(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 394
    .end local p0    # "this":Lcom/google/analytics/tracking/android/PersistentAnalyticsStore;
    :cond_0
    :goto_0
    return-object v4

    .line 309
    .restart local p0    # "this":Lcom/google/analytics/tracking/android/PersistentAnalyticsStore;
    :cond_1
    const/4 v14, 0x0
    ...
    .line 330
    :cond_2
    new-instance v3, Lcom/google/analytics/tracking/android/Hit;
    ...
    .end local p0    # "this":Lcom/google/analytics/tracking/android/PersistentAnalyticsStore;
    :cond_5
    instance-of v4, v14, Landroid/database/sqlite/SQLiteCursor;
    ...
    invoke-virtual {v15}, Landroid/database/sqlite/SQLiteCursor;->getWindow()Landroid/database/CursorWindow;
    ...
    check-cast p0, Lcom/google/analytics/tracking/android/Hit;
    ...
    invoke-virtual {v0, v1}, Lcom/google/analytics/tracking/android/Hit;->setHitString(Ljava/lang/String;)V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/analytics/tracking/android/Hit;->getHitId()J
    ...
    .line 380
    .local v21, "partialHits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    const/16 v17, 0x0
    ...
    .end local v21    # "partialHits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    :cond_c
    :try_start_6
    move-object/from16 v0, v19
    ...
    .restart local v3    # "hit":Lcom/google/analytics/tracking/android/Hit;
    .restart local v16    # "e":Landroid/database/sqlite/SQLiteException;
    .restart local v17    # "foundOneBadHit":Z
    .restart local v20    # "i$":Ljava/util/Iterator;
    .restart local v21    # "partialHits":Ljava/util/List;, "Ljava/util/List<Lcom/google/analytics/tracking/android/Hit;>;"
    :cond_e
    const/16 v17, 0x1
