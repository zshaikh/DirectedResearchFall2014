...
.method public getSchema(Lcom/flurry/org/codehaus/jackson/map/SerializerProvider;Ljava/lang/reflect/Type;)Lcom/flurry/org/codehaus/jackson/JsonNode;
    ...
    .prologue
    const-class v9, Lcom/flurry/org/codehaus/jackson/schema/JsonSerializableSchema;

    const-class v7, Lcom/flurry/org/codehaus/jackson/JsonNode;

    const-string v8, "##irrelevant"
    ...
    invoke-virtual {v4, v9}, Ljava/lang/Class;->isAnnotationPresent(Ljava/lang/Class;)Z
    ...
    new-instance v8, Lcom/flurry/org/codehaus/jackson/map/ObjectMapper;

    invoke-direct {v8}, Lcom/flurry/org/codehaus/jackson/map/ObjectMapper;-><init>()V

    const-class v9, Lcom/flurry/org/codehaus/jackson/JsonNode;

    invoke-virtual {v8, v3, v9}, Lcom/flurry/org/codehaus/jackson/map/ObjectMapper;->readValue(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p0

    .end local p0    # "this":Lcom/flurry/org/codehaus/jackson/map/ser/std/SerializableWithTypeSerializer;
    check-cast p0, Lcom/flurry/org/codehaus/jackson/JsonNode;

    invoke-virtual {v2, v7, p0}, Lcom/flurry/org/codehaus/jackson/node/ObjectNode;->put(Ljava/lang/String;Lcom/flurry/org/codehaus/jackson/JsonNode;)Lcom/flurry/org/codehaus/jackson/JsonNode;
    :try_end_0
    ...
    invoke-virtual {v8, v1, v9}, Lcom/flurry/org/codehaus/jackson/map/ObjectMapper;->readValue(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
