...
# static fields
.field private static final ALL_NORMALIZATION_MAPPINGS:Ljava/util/Map;
...
.field private static final CAPTURING_EXTN_DIGITS:Ljava/lang/String;

.field private static final CC_PATTERN:Ljava/util/regex/Pattern;

.field static final DIGIT_MAPPINGS:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.field static final KNOWN_EXTN_PATTERNS:Ljava/lang/String;
...
.field private static final PLUS_CHARS_PATTERN:Ljava/util/regex/Pattern;
...
.field private static final VALID_DIGITS:Ljava/lang/String;
...
.field private regionToMetadataMap:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-object v2, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->DIGIT_MAPPINGS:Ljava/util/Map;
    ...
    sput-object v3, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->ALPHA_MAPPINGS:Ljava/util/Map;
    ...
    sput-object v0, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->ALL_NORMALIZATION_MAPPINGS:Ljava/util/Map;
    ...
    sput-object v0, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->VALID_DIGITS:Ljava/lang/String;
    ...
    sget-object v1, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->VALID_DIGITS:Ljava/lang/String;
    ...
    sput-object v0, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->VALID_START_CHAR:Ljava/lang/String;

    sget-object v0, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->VALID_START_CHAR:Ljava/lang/String;
    ...
    sput-object v0, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->CAPTURING_EXTN_DIGITS:Ljava/lang/String;
    ...
    sget-object v1, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->CAPTURING_EXTN_DIGITS:Ljava/lang/String;
    ...
    const-string v1, "[ \u00a0\\t,]*(?:ext(?:ensi(?:o\u0301?|\u00f3))?n?|"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string v1, "\uff45\uff58\uff54\uff4e?|[,x\uff58#\uff03~\uff5e]|int|anexo|\uff49\uff4e\uff54)"
    ...
    sput-object v0, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->KNOWN_EXTN_PATTERNS:Ljava/lang/String;
    ...
    sget-object v1, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->KNOWN_EXTN_PATTERNS:Ljava/lang/String;
...
.method static declared-synchronized getInstance(Ljava/lang/String;Ljava/util/Map;)Lcom/google/i18n/phonenumbers/PhoneNumberUtil;
    ...
    iput-object p1, v1, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->countryCallingCodeToRegionCodeMap:Ljava/util/Map;
...
.method private loadMetadataForRegionFromFile(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->regionToMetadataMap:Ljava/util/Map;
...
.method private parseHelper(Ljava/lang/String;Ljava/lang/String;ZZLcom/google/i18n/phonenumbers/Phonenumber$PhoneNumber;)V
    ...
    invoke-virtual {p0, v3, v0}, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->maybeStripNationalPrefixAndCarrierCode(Ljava/lang/StringBuilder;Lcom/google/i18n/phonenumbers/Phonemetadata$PhoneMetadata;)Ljava/lang/String;
...
.method private parsePrefixAsIdd(Ljava/util/regex/Pattern;Ljava/lang/StringBuilder;)Z
    ...
    sget-object v1, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->CAPTURING_DIGIT_PATTERN:Ljava/util/regex/Pattern;
    ...
    sget-object v2, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->DIGIT_MAPPINGS:Ljava/util/Map;

    invoke-static {v1, v2, v4}, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->normalizeHelper(Ljava/lang/String;Ljava/util/Map;Z)Ljava/lang/String;
...
.method public formatOutOfCountryCallingNumber(Lcom/google/i18n/phonenumbers/Phonenumber$PhoneNumber;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v2, v1, v3}, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->formatNationalNumber(Ljava/lang/String;Ljava/lang/String;Lcom/google/i18n/phonenumbers/PhoneNumberUtil$PhoneNumberFormat;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v1, v2, v4}, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->maybeGetFormattedExtension(Lcom/google/i18n/phonenumbers/Phonenumber$PhoneNumber;Ljava/lang/String;Lcom/google/i18n/phonenumbers/PhoneNumberUtil$PhoneNumberFormat;Ljava/lang/StringBuilder;)V
    ...
    invoke-virtual {v1, v7, v0}, Ljava/lang/StringBuilder;->insert(II)Ljava/lang/StringBuilder;
    ...
    :cond_4
    invoke-virtual {v3}, Lcom/google/i18n/phonenumbers/Phonemetadata$PhoneMetadata;->hasPreferredInternationalPrefix()Z
    ...
    invoke-direct {p0, v0, v1, v4}, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->formatNumberByFormat(ILcom/google/i18n/phonenumbers/PhoneNumberUtil$PhoneNumberFormat;Ljava/lang/StringBuilder;)V
...
.method public isValidNumberForRegion(Lcom/google/i18n/phonenumbers/Phonenumber$PhoneNumber;Ljava/lang/String;)Z
    ...
    :cond_2
    invoke-direct {p0, v2, v0}, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->getNumberTypeHelper(Ljava/lang/String;Lcom/google/i18n/phonenumbers/Phonemetadata$PhoneMetadata;)Lcom/google/i18n/phonenumbers/PhoneNumberUtil$PhoneNumberType;
...
.method maybeExtractCountryCode(Ljava/lang/String;Lcom/google/i18n/phonenumbers/Phonemetadata$PhoneMetadata;Ljava/lang/StringBuilder;ZLcom/google/i18n/phonenumbers/Phonenumber$PhoneNumber;)I
    ...
    :cond_1
    invoke-virtual {p0, v0, v1}, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->maybeStripInternationalPrefixAndNormalize(Ljava/lang/StringBuilder;Ljava/lang/String;)Lcom/google/i18n/phonenumbers/Phonenumber$PhoneNumber$CountryCodeSource;
    ...
    invoke-virtual {p0, v4, p2}, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->maybeStripNationalPrefixAndCarrierCode(Ljava/lang/StringBuilder;Lcom/google/i18n/phonenumbers/Phonemetadata$PhoneMetadata;)Ljava/lang/String;
    ...
    invoke-virtual {v5, v2}, Lcom/google/i18n/phonenumbers/RegexCache;->getPatternForRegex(Ljava/lang/String;)Ljava/util/regex/Pattern;
    ...
    invoke-direct {p0, v2, v0}, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->testNumberLengthAgainstPattern(Ljava/util/regex/Pattern;Ljava/lang/String;)Lcom/google/i18n/phonenumbers/PhoneNumberUtil$ValidationResult;
    ...
    sget-object v0, Lcom/google/i18n/phonenumbers/Phonenumber$PhoneNumber$CountryCodeSource;->FROM_NUMBER_WITHOUT_PLUS_SIGN:Lcom/google/i18n/phonenumbers/Phonenumber$PhoneNumber$CountryCodeSource;
    ...
    :cond_9
    invoke-virtual {p5, v6}, Lcom/google/i18n/phonenumbers/Phonenumber$PhoneNumber;->setCountryCode(I)Lcom/google/i18n/phonenumbers/Phonenumber$PhoneNumber;
...
.method maybeStripNationalPrefixAndCarrierCode(Ljava/lang/StringBuilder;Lcom/google/i18n/phonenumbers/Phonemetadata$PhoneMetadata;)Ljava/lang/String;
    ...
    invoke-virtual {p1, v7, v1}, Ljava/lang/StringBuilder;->delete(II)Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v6, v7, v1, v5}, Ljava/lang/StringBuilder;->replace(IILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-virtual {p1, v7, v1, v2}, Ljava/lang/StringBuilder;->replace(IILjava/lang/String;)Ljava/lang/StringBuilder;
