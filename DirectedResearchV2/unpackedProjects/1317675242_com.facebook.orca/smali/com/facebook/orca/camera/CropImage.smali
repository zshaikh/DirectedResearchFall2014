...
.method private a(Landroid/graphics/Bitmap;)V
    ...
    iget-object v1, p0, Lcom/facebook/orca/camera/CropImage;->f:Landroid/net/Uri;
    ...
    .line 326
    :try_start_1
    iget-object v1, p0, Lcom/facebook/orca/camera/CropImage;->e:Landroid/graphics/Bitmap$CompressFormat;
    ...
    .line 332
    :cond_0
    invoke-static {v0}, Lcom/facebook/orca/camera/Util;->a(Ljava/io/Closeable;)V
    ...
    .line 343
    invoke-virtual {p0, v3}, Lcom/facebook/orca/camera/CropImage;->setResult(I)V
    ...
    iget-object v1, p0, Lcom/facebook/orca/camera/CropImage;->c:Lcom/facebook/orca/camera/HighlightView;

    invoke-virtual {v1}, Lcom/facebook/orca/camera/HighlightView;->b()Landroid/graphics/Rect;
    ...
    invoke-interface {v1}, Lcom/facebook/orca/camera/gallery/IImage;->b()Ljava/lang/String;
    ...
    invoke-interface {v1}, Lcom/facebook/orca/camera/gallery/IImage;->c()Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lcom/facebook/orca/camera/CropImage;->u:Lcom/facebook/orca/camera/gallery/IImage;

    invoke-interface {v2}, Lcom/facebook/orca/camera/gallery/IImage;->d()J
...
.method private b()V
    ...
    .line 248
    iget-object v1, p0, Lcom/facebook/orca/camera/CropImage;->q:Lcom/facebook/orca/camera/CropImageView;

    invoke-virtual {v1}, Lcom/facebook/orca/camera/CropImageView;->a()V
    ...
    invoke-virtual {v1, v0, v5}, Lcom/facebook/orca/camera/CropImageView;->a(Landroid/graphics/Bitmap;Z)V

    .line 293
    iget-object v1, p0, Lcom/facebook/orca/camera/CropImage;->q:Lcom/facebook/orca/camera/CropImageView;

    invoke-virtual {v1, v5, v5}, Lcom/facebook/orca/camera/CropImageView;->a(ZZ)V

    .line 294
    iget-object v1, p0, Lcom/facebook/orca/camera/CropImage;->q:Lcom/facebook/orca/camera/CropImageView;

    iget-object v1, v1, Lcom/facebook/orca/camera/CropImageView;->a:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/facebook/orca/camera/CropImage;->setResult(ILandroid/content/Intent;)V
    ...
    .line 258
    iget-boolean v1, p0, Lcom/facebook/orca/camera/CropImage;->k:Z
    ...
    invoke-direct {v2, p0, v0}, Lcom/facebook/orca/camera/CropImage$4;-><init>(Lcom/facebook/orca/camera/CropImage;Landroid/graphics/Bitmap;)V

    iget-object v0, p0, Lcom/facebook/orca/camera/CropImage;->l:Landroid/os/Handler;

    invoke-static {p0, v10, v1, v2, v0}, Lcom/facebook/orca/camera/Util;->a(Lcom/facebook/orca/camera/MonitoredActivity;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Runnable;Landroid/os/Handler;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 93
    invoke-virtual {p0, v3}, Lcom/facebook/orca/camera/CropImage;->requestWindowFeature(I)Z
    ...
    .line 105
    iput-boolean v3, p0, Lcom/facebook/orca/camera/CropImage;->k:Z

    .line 106
    iput v3, p0, Lcom/facebook/orca/camera/CropImage;->h:I

    .line 107
    iput v3, p0, Lcom/facebook/orca/camera/CropImage;->i:I
    ...
    .line 133
    iget-object v1, p0, Lcom/facebook/orca/camera/CropImage;->r:Landroid/content/ContentResolver;

    invoke-static {v1, v0, v3}, Lcom/facebook/orca/camera/ImageManager;->a(Landroid/content/ContentResolver;Landroid/net/Uri;I)Lcom/facebook/orca/camera/gallery/IImageList;

    move-result-object v1

    iput-object v1, p0, Lcom/facebook/orca/camera/CropImage;->t:Lcom/facebook/orca/camera/gallery/IImageList;

    .line 135
    iget-object v1, p0, Lcom/facebook/orca/camera/CropImage;->t:Lcom/facebook/orca/camera/gallery/IImageList;

    invoke-interface {v1, v0}, Lcom/facebook/orca/camera/gallery/IImageList;->a(Landroid/net/Uri;)Lcom/facebook/orca/camera/gallery/IImage;
    ...
    invoke-interface {v0, v3}, Lcom/facebook/orca/camera/gallery/IImage;->a(Z)Landroid/graphics/Bitmap;
