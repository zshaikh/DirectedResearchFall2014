...
.method public static read(Landroid/content/Context;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v7}, Lorg/acra/annotation/ReportsCrashes;->dropboxCollectionMinutes()I
    ...
    invoke-interface/range {p0 .. p0}, Lorg/acra/annotation/ReportsCrashes;->includeDropBoxSystemTags()Z
    ...
    sget-object v9, Lorg/acra/DropBoxCollector;->SYSTEM_TAGS:[Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p1}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z
    ...
    const-string p1, "DropBoxManager not available."
    ...
    :cond_6
    :try_start_3
    const-string p0, "No tag configured for collection."
