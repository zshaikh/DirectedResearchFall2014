...
.field m:Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;

.field final synthetic n:Landroid/support/v4/app/LoaderManagerImpl;
...
.method a()V
    ...
    .line 253
    iput-boolean v3, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->l:Z
...
.method public a(Landroid/support/v4/content/Loader;Ljava/lang/Object;)V
    ...
    .line 355
    :cond_3
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->m:Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;
    ...
    .line 361
    :cond_4
    iput-object v4, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->m:Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;

    .line 362
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->n:Landroid/support/v4/app/LoaderManagerImpl;

    iget-object v1, v1, Landroid/support/v4/app/LoaderManagerImpl;->b:Landroid/support/v4/app/HCSparseArray;

    iget v2, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->a:I

    invoke-virtual {v1, v2, v4}, Landroid/support/v4/app/HCSparseArray;->b(ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/HCSparseArray;->c(I)V
...
.method b(Landroid/support/v4/content/Loader;Ljava/lang/Object;)V
    ...
    iget-object v0, v0, Landroid/support/v4/app/FragmentManagerImpl;->s:Ljava/lang/String;
    ...
    iput-object v2, v1, Landroid/support/v4/app/FragmentManagerImpl;->s:Ljava/lang/String;
    ...
    invoke-virtual {p1, p2}, Landroid/support/v4/content/Loader;->b(Ljava/lang/Object;)Ljava/lang/String;
    ...
    iput-object v0, v1, Landroid/support/v4/app/FragmentManagerImpl;->s:Ljava/lang/String;
    ...
    iget-object v2, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->n:Landroid/support/v4/app/LoaderManagerImpl;
    ...
    iput-object v0, v2, Landroid/support/v4/app/FragmentManagerImpl;->s:Ljava/lang/String;
...
.method c()V
    ...
    .line 276
    invoke-virtual {p0}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->d()V
...
.method e()V
    ...
    .line 309
    iput-boolean v3, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->f:Z
    ...
    invoke-interface {v1, v2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->a(Landroid/support/v4/content/Loader;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 325
    :cond_2
    iput-object v4, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->c:Landroid/support/v4/app/LoaderManager$LoaderCallbacks;

    .line 326
    iput-object v4, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->g:Ljava/lang/Object;

    .line 327
    iput-boolean v3, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->e:Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/content/Loader;->k()V
