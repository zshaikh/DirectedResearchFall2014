...
public class XMLMap extends Map
{
	...
	/*	public XMLMap(String fullString, String projectName, String fileName,
	...
	*/
		...
		{
		//	System.out.println("Search From XMLMap");
			try 
			{
				if(this.key!= null)
			...
			{
				System.out.println("key Name: "+this.key.getKeyName() +"Key Hex Id: "+ this.key.getHexId());
			ex.printStackTrace();
			}
		...
		public String print(String result , PrintWriter writer)
		{
			...
			if(this.key != null)
				//System.out.print(this.getFileName()+","+ this.key.print(result,writer)) ;
				writer.print("Other XML:"+this.getFileName()+","+ this.key.print(result,writer));
				else 
					//System.out.print( this.getFileName());
					writer.print(this.getFileName());
			return result;
