...
public final class j extends Activity
{
    ...
    private static String a(final View view) {
        ...
        char c9 = '\0';
        char c10 = '\0';
        Label_0493_Outer:Label_0605_Outer:
        while (true) {
        Label_0612_Outer:
            while (true) {
                while (true) {
                    Label_0570_Outer:Label_0584_Outer:
                    while (true) {
                        Label_0275: {
                        Label_0591_Outer:
                            while (true) {
    ...
    final y a(final String s, final boolean b, final boolean b2) {
        ...
        y value = this.l.get(s);
        if (value == null) {
            if (b2) {
                value = new y(s, this, b);
                this.l.put(s, value);
            }
            return value;
        }
    ...
    public final boolean onPreparePanel(final int n, final View view, final Menu menu) {
        if (n == 0 && menu != null) {
            ...
            return (super.onPreparePanel(n, view, menu) | this.b.a(menu)) && menu.hasVisibleItems();
        }
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        final ArrayList d = this.b.d();
        final HashMap l = this.l;
        boolean b = false;
        if (l != null) {
            final y[] array = new y[this.l.size()];
            this.l.values().toArray(array);
    ...
    protected final void onStart() {
        ...
        if (!this.k) {
            ...
            if (this.m != null) {
                ...
                this.m = this.a(null, this.k, false);
