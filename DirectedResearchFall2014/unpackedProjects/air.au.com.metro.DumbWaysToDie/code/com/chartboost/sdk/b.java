...
public abstract class b
{
    ...
    public b(final com.chartboost.sdk.impl.a g) {
        super();
        this.a = null;
        this.b = null;
        this.c = null;
    ...
    protected void a(final String s, final e.b b) {
        this.a(s, b, false);
    }
    
    protected void a(final String s, final e.b b, final boolean b2) {
    ...
    protected void a(final JSONObject jsonObject, final String s, final e.b b, final Bundle bundle) {
        final JSONObject optJSONObject = jsonObject.optJSONObject(s);
        if (optJSONObject != null) {
            ++this.j;
            com.chartboost.sdk.Libraries.e.a().a(optJSONObject.optString("url"), optJSONObject.optString("checksum"), b, null, bundle);
            return;
        }
    ...
    public boolean b() {
        ...
        final Activity b = Chartboost.sharedChartboost().b();
        if (b == null) {
            this.k = null;
            return false;
        }
        this.k = this.a((Context)b);
        if (this.k.a(b)) {
            return true;
        }
        this.k = null;
    ...
    public abstract class b extends RelativeLayout implements s.a
    {
        protected boolean a;
