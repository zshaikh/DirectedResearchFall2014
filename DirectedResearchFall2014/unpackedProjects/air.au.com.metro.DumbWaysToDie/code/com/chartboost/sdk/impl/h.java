...
public class h extends com.chartboost.sdk.b
{
    ...
    public class a extends b
    {
        ...
        private a(final Context context) {
            ...
            this.g = new q(context, b ? 1 : 0);
            this.g.b().setBackgroundColor(-1842205);
            this.f.setFocusable(false);
            this.e.setFocusable(false);
            this.d.setFocusable(false);
            this.d.setClickable(true);
            this.h = new t(context, (View)this.d);
            this.addView((View)(this.i = new t(context, (View)this.f)));
            ...
            public View getView(int n, final View view, final ViewGroup viewGroup) {
                ...
                if (view == null) {
                    if (optString.equals("featured")) {
                        ...
                        b = new com.chartboost.sdk.impl.e(this.a);
                    }
                    else {
                    ...
                    t = new t(this.a, (View)b);
                }
                else {
                    final t t2 = (t)view;
                    final h.b b2 = (h.b)t2.a();
                    t = t2;
                    b = b2;
                }
                b.a(a, n);
                final com.chartboost.sdk.impl.c c = (com.chartboost.sdk.impl.c)b;
                if (forcedOrientationDifference.isOdd()) {
                    t.setLayoutParams((ViewGroup$LayoutParams)new AbsListView$LayoutParams(b.a(), -1));
                }
                else {
                    t.setLayoutParams((ViewGroup$LayoutParams)new AbsListView$LayoutParams(-1, b.a()));
                }
                ...
                if (b instanceof com.chartboost.sdk.impl.e) {
                    ((com.chartboost.sdk.impl.e)b).b.setOnClickListener((View$OnClickListener)view$OnClickListener);
                }
                return (View)t;
            }
        }
