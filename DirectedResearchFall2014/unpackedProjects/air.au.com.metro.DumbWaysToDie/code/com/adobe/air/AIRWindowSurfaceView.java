...
public class AIRWindowSurfaceView extends SurfaceView implements SurfaceHolder$Callback
{
                ...
                while (true) {
                    ...
                    while (true) {
                        ...
                        if (n15 != 0) {
                            ...
                            int n16;
                            if (n3 != 0 && Entrypoints.registerTouchCallback(0, touchEventData)) {
                                n16 = 1;
                            }
                            else {
                                n16 = 0;
                        ...
                        int n17;
                        if (n3 != 0 && Entrypoints.registerTouchCallback(0, touchEventData2)) {
                            n17 = 1;
                        }
                        else {
                            n17 = 0;
    ...
    public void surfaceCreated(final SurfaceHolder surfaceHolder) {
        ...
        if (this.mActivityWrapper.isStarted() || this.mActivityWrapper.isResumed()) {
    ...
    class HoverTimeoutHandler extends Handler
    {
        ...
        public void handleMessage(final Message message) {
            if (System.currentTimeMillis() - this.mLastMove >= 500L) {
                ...
                Entrypoints.registerTouchCallback(0, new TouchEventData(32, this.mAIRWindowSurfaceView.mLastTouchedXCoord, this.mAIRWindowSurfaceView.mLastTouchedYCoord, 0.0f, 0, 0.0f, 0.0f, true, null, this.mAIRWindowSurfaceView.mHoverMetaState));
                return;
            }
