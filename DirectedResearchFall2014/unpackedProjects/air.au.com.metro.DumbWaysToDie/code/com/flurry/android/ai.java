...
final class ai extends AdNetworkView
{
    ...
    public final void initLayout(final Context context) {
        ...
        AdSize obj = new AdSize(n2, n).findBestSize(new AdSize[] { AdSize.IAB_LEADERBOARD, AdSize.IAB_BANNER, AdSize.BANNER, AdSize.IAB_MRECT });
        ...
        adView.setAdListener((AdListener)new ae(this));
        this.setGravity(17);
