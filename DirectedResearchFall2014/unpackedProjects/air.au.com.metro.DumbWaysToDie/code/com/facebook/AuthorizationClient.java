...
class AuthorizationClient implements Serializable
{
    ...
    private List getHandlerTypes(final AuthorizationClient$AuthorizationRequest authorizationClient$AuthorizationRequest) {
        final ArrayList<AuthorizationClient$GetTokenAuthHandler> list = new ArrayList<AuthorizationClient$GetTokenAuthHandler>();
    ...
    boolean checkInternetPermission() {
        ...
        if (this.checkPermission("android.permission.INTERNET") != 0) {
            this.complete(AuthorizationClient$Result.createErrorResult("AndroidManifest Error", "WebView login requires INTERNET permission"));
            return false;
        }
