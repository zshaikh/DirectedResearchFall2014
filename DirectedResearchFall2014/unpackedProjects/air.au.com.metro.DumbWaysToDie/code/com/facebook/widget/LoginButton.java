...
public class LoginButton extends Button
{
    ...
    public LoginButton(final Context context, final AttributeSet set) {
        ...
        if (set.getStyleAttribute() == 0) {
            this.setTextColor(this.getResources().getColor(b.a("color.com_facebook_loginview_text_color")));
            this.setTextSize(0, this.getResources().getDimension(b.a("dimen.com_facebook_loginview_text_size")));
            this.setPadding(this.getResources().getDimensionPixelSize(b.a("dimen.com_facebook_loginview_padding_left")), this.getResources().getDimensionPixelSize(b.a("dimen.com_facebook_loginview_padding_top")), this.getResources().getDimensionPixelSize(b.a("dimen.com_facebook_loginview_padding_right")), this.getResources().getDimensionPixelSize(b.a("dimen.com_facebook_loginview_padding_bottom")));
            this.setWidth(this.getResources().getDimensionPixelSize(b.a("dimen.com_facebook_loginview_width")));
            this.setHeight(this.getResources().getDimensionPixelSize(b.a("dimen.com_facebook_loginview_height")));
            this.setGravity(17);
            this.parseAttributes(set);
            if (this.isInEditMode()) {
                this.setBackgroundColor(this.getResources().getColor(b.a("color.com_facebook_blue")));
                this.loginText = "Log in";
            }
            else {
                this.setBackgroundResource(b.a("drawable.com_facebook_loginbutton_blue"));
            }
        }
        this.parseAttributes(set);
        if (!this.isInEditMode()) {
    ...
    private void parseAttributes(final AttributeSet set) {
        final TypedArray obtainStyledAttributes = this.getContext().obtainStyledAttributes(set, b.b("styleable.com_facebook_login_view"));
        this.confirmLogout = obtainStyledAttributes.getBoolean(b.a("styleable.com_facebook_login_view_confirm_logout"), true);
        this.fetchUserInfo = obtainStyledAttributes.getBoolean(b.a("styleable.com_facebook_login_view_fetch_user_info"), true);
        this.loginText = obtainStyledAttributes.getString(b.a("styleable.com_facebook_login_view_login_text"));
        this.logoutText = obtainStyledAttributes.getString(b.a("styleable.com_facebook_login_view_logout_text"));
    ...
    private void setButtonText() {
        if (this.sessionTracker != null && this.sessionTracker.getOpenSession() != null) {
            ...
            if (this.logoutText != null) {
                ...
                text = this.getResources().getString(b.a("string.com_facebook_loginview_log_out_button"));
            }
        ...
        if (this.loginText != null) {
            ...
            text2 = this.getResources().getString(b.a("string.com_facebook_loginview_log_in_button"));
        }
