...
public class ProfilePictureView extends FrameLayout
{
    ...
    private int getPresetSizeInPixels(final boolean b) {
        ...
        switch (this.presetSizeType) {
            ...
            case -2: {
                n = b.a("dimen.com_facebook_profilepictureview_preset_size_small");
                break;
            }
            case -3: {
                n = b.a("dimen.com_facebook_profilepictureview_preset_size_normal");
                break;
            }
            case -4: {
                n = b.a("dimen.com_facebook_profilepictureview_preset_size_large");
                break;
            }
            case -1: {
                if (!b) {
    ...
    private void parseAttributes(final AttributeSet set) {
        final TypedArray obtainStyledAttributes = this.getContext().obtainStyledAttributes(set, b.b("styleable.com_facebook_profile_picture_view"));
        this.setPresetSize(obtainStyledAttributes.getInt(b.a("styleable.com_facebook_profile_picture_view_preset_size"), -1));
        this.isCropped = obtainStyledAttributes.getBoolean(b.a("styleable.com_facebook_profile_picture_view_is_cropped"), true);
    ...
    private void setBlankProfilePicture() {
        int n;
        if (this.isCropped()) {
            n = b.a("drawable.com_facebook_profile_picture_blank_square");
        }
        else {
            n = b.a("drawable.com_facebook_profile_picture_blank_portrait");
        }
