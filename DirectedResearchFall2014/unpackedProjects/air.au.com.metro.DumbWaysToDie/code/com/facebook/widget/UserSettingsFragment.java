...
public class UserSettingsFragment extends FacebookFragment
{
    ...
    private void processImageResponse(final String userProfilePicID, final ImageResponse imageResponse) {
        if (imageResponse != null) {
            ...
            if (bitmap != null) {
                ...
                userProfilePic.setBounds(0, 0, this.getResources().getDimensionPixelSize(b.a("dimen.com_facebook_usersettingsfragment_profile_picture_width")), this.getResources().getDimensionPixelSize(b.a("dimen.com_facebook_usersettingsfragment_profile_picture_height")));
    ...
    private void updateUI() {
        ...
        if (!this.isSessionOpen()) {
            final int color = this.getResources().getColor(b.a("color.com_facebook_usersettingsfragment_not_connected_text_color"));
            this.connectedStateLabel.setTextColor(color);
            this.connectedStateLabel.setShadowLayer(0.0f, 0.0f, 0.0f, color);
            this.connectedStateLabel.setText((CharSequence)this.getResources().getString(b.a("string.com_facebook_usersettingsfragment_not_logged_in")));
        ...
        this.connectedStateLabel.setTextColor(this.getResources().getColor(b.a("color.com_facebook_usersettingsfragment_connected_text_color")));
        this.connectedStateLabel.setShadowLayer(1.0f, 0.0f, -1.0f, this.getResources().getColor(b.a("color.com_facebook_usersettingsfragment_connected_shadow_color")));
        if (this.user != null) {
        ...
        this.connectedStateLabel.setText((CharSequence)this.getResources().getString(b.a("string.com_facebook_usersettingsfragment_logged_in")));
        final Drawable drawable = this.getResources().getDrawable(b.a("drawable.com_facebook_profile_default_icon"));
        drawable.setBounds(0, 0, this.getResources().getDimensionPixelSize(b.a("dimen.com_facebook_usersettingsfragment_profile_picture_width")), this.getResources().getDimensionPixelSize(b.a("dimen.com_facebook_usersettingsfragment_profile_picture_height")));
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        final View inflate = layoutInflater.inflate(b.a("layout.com_facebook_usersettingsfragment"), viewGroup, false);
        (this.loginButton = (LoginButton)inflate.findViewById(b.a("id.com_facebook_usersettingsfragment_login_button"))).setProperties(this.loginButtonProperties);
        this.loginButton.setFragment(this);
        final Session session = this.getSession();
        if (session != null && !session.equals(Session.getActiveSession())) {
            this.loginButton.setSession(session);
        }
        this.connectedStateLabel = (TextView)inflate.findViewById(b.a("id.com_facebook_usersettingsfragment_profile_name"));
        if (inflate.getBackground() == null) {
            inflate.setBackgroundColor(this.getResources().getColor(b.a("color.com_facebook_blue")));
            return inflate;
        }
    ...
    public void setPublishPermissions(final List list) {
        this.loginButtonProperties.setPublishPermissions(list, this.getSession());
    }
    
    public void setReadPermissions(final List list) {
