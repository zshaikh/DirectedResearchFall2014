...
public class FuseNotificationCompat
{
    ...
    public static class Builder
    {
        ...
        public Notification build() {
            return FuseNotificationCompat.IMPL.build(this);
        }
        ...
        public Builder setLights(final int ledARGB, final int ledOnMS, final int ledOffMS) {
            ...
            final Notification mNotification = this.mNotification;
            final int n2 = 0xFFFFFFFE & this.mNotification.flags;
            boolean b = false;
            if (n != 0) {
                b = true;
            }
            mNotification.flags = (n2 | (b ? 1 : 0));
            return this;
        }
    ...
    static class NotificationCompatImplHoneycomb implements NotificationCompatImpl
    {
        @Override
        public Notification build(final Builder builder) {
            return FuseNotificationCompatHoneycomb.add(builder.mContext, builder.mNotification, builder.mContentTitle, builder.mContentText, builder.mContentInfo, builder.mTickerView, builder.mNumber, builder.mContentIntent, builder.mFullScreenIntent, builder.mLargeIcon);
        }
    }
    ...
    static class NotificationCompatImplIceCreamSandwich implements NotificationCompatImpl
    {
        @Override
        public Notification build(final Builder builder) {
            return FuseNotificationCompatIceCreamSandwich.add(builder.mContext, builder.mNotification, builder.mContentTitle, builder.mContentText, builder.mContentInfo, builder.mTickerView, builder.mNumber, builder.mContentIntent, builder.mFullScreenIntent, builder.mLargeIcon, builder.mProgressMax, builder.mProgress, builder.mProgressIndeterminate);
        }
    }
    ...
    static class NotificationCompatImplJellybean implements NotificationCompatImpl
    {
        @Override
        public Notification build(final Builder builder) {
            final FuseNotificationCompatJellybean fuseNotificationCompatJellybean = new FuseNotificationCompatJellybean(builder.mContext, builder.mNotification, builder.mContentTitle, builder.mContentText, builder.mContentInfo, builder.mTickerView, builder.mNumber, builder.mContentIntent, builder.mFullScreenIntent, builder.mLargeIcon, builder.mProgressMax, builder.mProgress, builder.mProgressIndeterminate, builder.mUseChronometer, builder.mPriority, builder.mSubText);
            for (final Action action : builder.mActions) {
                fuseNotificationCompatJellybean.addAction(action.icon, action.title, action.actionIntent);
            }
            if (builder.mStyle != null) {
                if (builder.mStyle instanceof BigTextStyle) {
                    final BigTextStyle bigTextStyle = (BigTextStyle)builder.mStyle;
                    fuseNotificationCompatJellybean.addBigTextStyle(bigTextStyle.mBigContentTitle, bigTextStyle.mSummaryTextSet, bigTextStyle.mSummaryText, bigTextStyle.mBigText);
                }
                else if (builder.mStyle instanceof InboxStyle) {
                    final InboxStyle inboxStyle = (InboxStyle)builder.mStyle;
                    fuseNotificationCompatJellybean.addInboxStyle(inboxStyle.mBigContentTitle, inboxStyle.mSummaryTextSet, inboxStyle.mSummaryText, inboxStyle.mTexts);
                }
                else if (builder.mStyle instanceof BigPictureStyle) {
                    final BigPictureStyle bigPictureStyle = (BigPictureStyle)builder.mStyle;
                    fuseNotificationCompatJellybean.addBigPictureStyle(bigPictureStyle.mBigContentTitle, bigPictureStyle.mSummaryTextSet, bigPictureStyle.mSummaryText, bigPictureStyle.mPicture, bigPictureStyle.mBigLargeIcon, bigPictureStyle.mBigLargeIconSet);
                }
            }
            return fuseNotificationCompatJellybean.build();
        }
    }
