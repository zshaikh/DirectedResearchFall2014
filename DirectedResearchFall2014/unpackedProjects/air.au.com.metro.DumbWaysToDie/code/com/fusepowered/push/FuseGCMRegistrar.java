...
public final class FuseGCMRegistrar
{
    ...
    public static void checkManifest(final Context p0) {
        ...
        //   283: invokestatic    com/fusepowered/push/FuseGCMRegistrar.checkReceiver:(Landroid/content/Context;Ljava/util/Set;Ljava/lang/String;)V
        //   286: aload_0        
        //   287: aload           9
        //   289: ldc             "com.google.android.c2dm.intent.RECEIVE"
        //   291: invokestatic    com/fusepowered/push/FuseGCMRegistrar.checkReceiver:(Landroid/content/Context;Ljava/util/Set;Ljava/lang/String;)V
        //   294: return         
        //    Exceptions:
        //  Try           Handler
    ...
    public static void onDestroy(final Context context) {
        synchronized (FuseGCMRegistrar.class) {
            if (FuseGCMRegistrar.sRetryReceiver != null) {
                Log.v("GCMRegistrar", "Unregistering receiver");
                context.unregisterReceiver((BroadcastReceiver)FuseGCMRegistrar.sRetryReceiver);
                FuseGCMRegistrar.sRetryReceiver = null;
            }
        }
    }
    ...
    static void setRetryBroadcastReceiver(final Context context) {
        synchronized (FuseGCMRegistrar.class) {
            if (FuseGCMRegistrar.sRetryReceiver == null) {
                if (FuseGCMRegistrar.sRetryReceiverClassName == null) {
                    Log.e("GCMRegistrar", "internal error: retry receiver class not set yet");
                    FuseGCMRegistrar.sRetryReceiver = new FuseGCMBroadcastReceiver();
                }
                else {
                    try {
                        FuseGCMRegistrar.sRetryReceiver = (FuseGCMBroadcastReceiver)Class.forName(FuseGCMRegistrar.sRetryReceiverClassName).newInstance();
                    }
                    catch (Exception ex) {
                        Log.e("GCMRegistrar", "Could not create instance of " + FuseGCMRegistrar.sRetryReceiverClassName + ". Using " + FuseGCMBroadcastReceiver.class.getName() + " directly.");
                        FuseGCMRegistrar.sRetryReceiver = new FuseGCMBroadcastReceiver();
                    }
                }
                final String packageName = context.getPackageName();
                ...
                context.registerReceiver((BroadcastReceiver)FuseGCMRegistrar.sRetryReceiver, intentFilter, string, (Handler)null);
            }
        }
    }
    ...
    static void setRetryReceiverClassName(final String s) {
        ...
        FuseGCMRegistrar.sRetryReceiverClassName = s;
    }
