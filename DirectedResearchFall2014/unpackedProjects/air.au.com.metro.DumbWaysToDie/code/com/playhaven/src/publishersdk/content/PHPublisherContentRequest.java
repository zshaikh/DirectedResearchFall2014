...
public class PHPublisherContentRequest extends PHContentRequest implements PHAPIRequest
{
    ...
    {
        ApplicationTriggered("ApplicationTriggered", 2), 
        CloseButtonTriggered("CloseButtonTriggered", 1), 
        ContentUnitTriggered("ContentUnitTriggered", 0), 
        NoContentTriggered("NoContentTriggered", 3);
    }
