...
public class AndroidActivityWrapper
{
    ...
    static {
        ...
        AndroidActivityWrapper.sIsSwfPreviewMode = false;
        AndroidActivityWrapper.sDepthAndStencil = false;
    }
    ...
    public static boolean GetDepthAndStencilForGamePreview() {
        return AndroidActivityWrapper.sDepthAndStencil;
    }
    ...
    public static boolean IsGamePreviewMode() {
        return AndroidActivityWrapper.sIsSwfPreviewMode;
    }
    ...
    private void LaunchApplication(final Activity p0, final AIRWindowSurfaceView p1, final String p2, final String p3, final String p4, final boolean p5, final boolean p6) {
        ...
        //   230: return         
        //   231: getstatic       com/adobe/air/AndroidActivityWrapper.sIsSwfPreviewMode:Z
        //   234: istore          8
        //   236: iload           8
        //   238: ifeq            606
        //   241: aload_1        
        //   242: invokevirtual   android/app/Activity.getIntent:()Landroid/content/Intent;
        //   245: invokevirtual   android/content/Intent.getDataString:()Ljava/lang/String;
        //   248: astore          15
        //   250: aload           15
        //   252: ifnull          541
        //   255: aload           15
        //   257: ldc_w           "?"
        //   260: invokevirtual   java/lang/String.indexOf:(Ljava/lang/String;)I
        //   263: ifle            541
        //   266: aload           15
        //   268: iconst_1       
        //   269: aload           15
        ...
        //   277: iadd           
        //   278: invokevirtual   java/lang/String.substring:(I)Ljava/lang/String;
        //   281: ldc_w           "&"
        //   284: invokevirtual   java/lang/String.split:(Ljava/lang/String;)[Ljava/lang/String;
        //   287: astore          16
        //   289: aload           16
        //   291: arraylength    
        //   292: istore          17
        ...
        //   317: aload           20
        //   319: ldc_w           "="
        //   322: invokevirtual   java/lang/String.indexOf:(Ljava/lang/String;)I
        //   325: invokevirtual   java/lang/String.substring:(II)Ljava/lang/String;
        //   328: ldc_w           "depthAndStencil"
        //   331: invokevirtual   java/lang/String.equalsIgnoreCase:(Ljava/lang/String;)Z
        //   334: ifeq            375
        //   337: aload           20
        //   339: iconst_1       
        //   340: aload           20
        //   342: ldc_w           "="
        //   345: invokevirtual   java/lang/String.indexOf:(Ljava/lang/String;)I
        //   348: iadd           
        //   349: invokevirtual   java/lang/String.substring:(I)Ljava/lang/String;
        //   352: ldc_w           "true"
        //   355: invokevirtual   java/lang/String.equalsIgnoreCase:(Ljava/lang/String;)Z
        //   358: ifeq            368
        //   361: iconst_1       
        //   362: putstatic       com/adobe/air/AndroidActivityWrapper.sDepthAndStencil:Z
        //   365: goto            676
        //   368: iconst_0       
        //   369: putstatic       com/adobe/air/AndroidActivityWrapper.sDepthAndStencil:Z
        //   372: goto            676
        //   375: aload           20
        //   377: iconst_0       
        //   378: aload           20
        //   380: ldc_w           "="
        //   383: invokevirtual   java/lang/String.indexOf:(Ljava/lang/String;)I
        //   386: invokevirtual   java/lang/String.substring:(II)Ljava/lang/String;
        //   389: ldc_w           "autoorients"
        //   392: invokevirtual   java/lang/String.equalsIgnoreCase:(Ljava/lang/String;)Z
        //   395: ifeq            438
        //   398: aload           20
        //   400: iconst_1       
        //   401: aload           20
        //   403: ldc_w           "="
        //   406: invokevirtual   java/lang/String.indexOf:(Ljava/lang/String;)I
        //   409: iadd           
        //   410: invokevirtual   java/lang/String.substring:(I)Ljava/lang/String;
        //   413: ldc_w           "true"
        //   416: invokevirtual   java/lang/String.equalsIgnoreCase:(Ljava/lang/String;)Z
        //   419: ifeq            430
        //   422: aload_0        
        //   423: iconst_1       
        //   424: invokevirtual   com/adobe/air/AndroidActivityWrapper.setAutoOrients:(Z)V
        //   427: goto            676
        //   430: aload_0        
        //   431: iconst_0       
        //   432: invokevirtual   com/adobe/air/AndroidActivityWrapper.setAutoOrients:(Z)V
        //   435: goto            676
        //   438: aload           20
        //   440: iconst_0       
        //   441: aload           20
        ...
        //   449: invokevirtual   java/lang/String.substring:(II)Ljava/lang/String;
        //   452: ldc_w           "aspectratio"
        ...
        //   464: aload           20
        //   466: ldc_w           "="
        //   469: invokevirtual   java/lang/String.indexOf:(Ljava/lang/String;)I
        //   472: iadd           
        //   473: invokevirtual   java/lang/String.substring:(I)Ljava/lang/String;
        //   476: astore          21
        //   478: aload           21
        //   480: ldc_w           "portrait"
        //   483: invokevirtual   java/lang/String.equalsIgnoreCase:(Ljava/lang/String;)Z
        //   486: ifeq            495
        //   489: iconst_1       
        //   490: istore          18
        //   492: goto            676
        ...
        //   512: aload           21
        //   514: ldc_w           "any"
        //   517: invokevirtual   java/lang/String.equalsIgnoreCase:(Ljava/lang/String;)Z
        //   520: ifeq            676
        //   523: iconst_3       
        //   524: istore          18
        //   526: goto            676
        ...
        //   535: aload_0        
        //   536: iload           18
        //   538: invokevirtual   com/adobe/air/AndroidActivityWrapper.setAspectRatio:(I)V
        //   541: aload           5
        //   543: astore          9
        //   545: aload           4
        //   547: astore          10
        ...
        //  -----  -----  -----  -----  ---------------------
        //  12     24     644    657    Ljava/lang/Exception;
        //  29     45     644    657    Ljava/lang/Exception;
        //  45     51     555    572    Ljava/lang/Exception;
        //  51     83     572    589    Ljava/lang/Exception;
        //  94     133    589    606    Ljava/lang/Exception;
        //  171    230    641    644    Ljava/lang/Exception;
        //  231    236    641    644    Ljava/lang/Exception;
        //  241    250    682    698    Ljava/lang/Exception;
        //  255    294    682    698    Ljava/lang/Exception;
        //  307    365    682    698    Ljava/lang/Exception;
        //  368    372    682    698    Ljava/lang/Exception;
        //  375    427    682    698    Ljava/lang/Exception;
        //  430    435    682    698    Ljava/lang/Exception;
        //  438    489    682    698    Ljava/lang/Exception;
        //  495    506    682    698    Ljava/lang/Exception;
        //  512    523    682    698    Ljava/lang/Exception;
        //  535    541    682    698    Ljava/lang/Exception;
        // 
    ...
    private void LoadRuntimeLibraries() {
        ...
        try {
            System.load(Utils.GetLibSTLPath((Context)this.m_application));
    ...
    private void parseArgs(final Activity p0, final String[] p1) {
        ...
        //    69: aload_0        
        //    70: aload           11
        //    72: putfield        com/adobe/air/AndroidActivityWrapper.mExtraArgs:Ljava/lang/String;
        //    75: aload_0        
        //    76: aload           12
        //    78: invokestatic    java/lang/Boolean.valueOf:(Ljava/lang/String;)Ljava/lang/Boolean;
        //    81: invokevirtual   java/lang/Boolean.booleanValue:()Z
        //    84: putfield        com/adobe/air/AndroidActivityWrapper.mIsADL:Z
        //    87: aload_0        
        //    88: aload           13
        //    90: invokestatic    java/lang/Boolean.valueOf:(Ljava/lang/String;)Ljava/lang/Boolean;
        //    93: invokevirtual   java/lang/Boolean.booleanValue:()Z
        //    96: putfield        com/adobe/air/AndroidActivityWrapper.mIsDebuggerMode:Z
        //    99: aload           14
        //   101: invokestatic    java/lang/Boolean.valueOf:(Ljava/lang/String;)Ljava/lang/Boolean;
        //   104: invokevirtual   java/lang/Boolean.booleanValue:()Z
        //   107: putstatic       com/adobe/air/AndroidActivityWrapper.sIsSwfPreviewMode:Z
        //   110: aload_0        
        //   111: aload_0        
        //   112: getfield        com/adobe/air/AndroidActivityWrapper.m_activity:Landroid/app/Activity;
        //   115: invokevirtual   android/app/Activity.getApplicationInfo:()Landroid/content/pm/ApplicationInfo;
        //   118: invokespecial   com/adobe/air/AndroidActivityWrapper.initializeAndroidAppVars:(Landroid/content/pm/ApplicationInfo;)V
        //   121: aload_0        
        //   122: getfield        com/adobe/air/AndroidActivityWrapper.mIsADL:Z
        //   125: ifeq            186
        //   128: aload_0        
        //   129: aload           9
        //   131: putfield        com/adobe/air/AndroidActivityWrapper.mXmlPath:Ljava/lang/String;
        //   134: aload_0        
        //   135: aload           10
        //   137: putfield        com/adobe/air/AndroidActivityWrapper.mRootDir:Ljava/lang/String;
        //   140: return         
        //   141: astore          4
        //   143: ldc_w           "false"
        //   146: astore          5
        ...
        //   183: goto            69
        //   186: aload_0        
        //   187: invokestatic    com/adobe/air/ApplicationFileManager.getAppXMLRoot:()Ljava/lang/String;
        //   190: putfield        com/adobe/air/AndroidActivityWrapper.mXmlPath:Ljava/lang/String;
        //   193: aload_0        
        //   194: invokestatic    com/adobe/air/ApplicationFileManager.getAppRoot:()Ljava/lang/String;
        //   197: putfield        com/adobe/air/AndroidActivityWrapper.mRootDir:Ljava/lang/String;
        //   200: return         
        //   201: astore          16
        //   203: ldc_w           "false"
        //   206: astore          6
        ...
        //  Start  End    Start  End    Type                                      
        //  -----  -----  -----  -----  ------------------------------------------
        //  4      9      141    159    Ljava/lang/ArrayIndexOutOfBoundsException;
        //  9      14     201    223    Ljava/lang/ArrayIndexOutOfBoundsException;
        //  14     19     223    248    Ljava/lang/ArrayIndexOutOfBoundsException;
        //  19     24     248    270    Ljava/lang/ArrayIndexOutOfBoundsException;
        //  24     29     270    291    Ljava/lang/ArrayIndexOutOfBoundsException;
        //  29     41     291    311    Ljava/lang/ArrayIndexOutOfBoundsException;
        // 
        // The error that occurred was:
        // 
