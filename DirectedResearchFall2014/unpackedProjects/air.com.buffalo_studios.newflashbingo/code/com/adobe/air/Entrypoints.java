...
public class Entrypoints
{
    ...
    static {
        ...
        Entrypoints.mMainHandler = new customHandler();
    }
    ...
    public static Handler getMainHandler() {
        return Entrypoints.mMainHandler;
    }
    ...
    public static void registerCallback(final int n, final int arg1, final int arg2, final Handler handler) {
        Handler mMainHandler;
        if (handler == null) {
            mMainHandler = Entrypoints.mMainHandler;
        }
        else {
        ...
        obtain.arg2 = arg2;
        if (n > 0) {
            mMainHandler.sendMessageDelayed(obtain, (long)n);
            return;
        }
        mMainHandler.sendMessage(obtain);
    }
    
    public static boolean registerKeyCallback(final int n, final KeyEventData obj, final Handler handler) {
        Handler mMainHandler;
        if (handler == null) {
            mMainHandler = Entrypoints.mMainHandler;
        }
    ...
    public static boolean registerTouchCallback(final int n, final TouchEventData obj, final Handler handler) {
        Handler mMainHandler;
        if (handler == null) {
            mMainHandler = Entrypoints.mMainHandler;
        }
    ...
    public boolean EntryDownloadConfig(final Object o, final String s) {
        ...
        System.load(Utils.GetLibSTLPath(Entrypoints.s_context));
