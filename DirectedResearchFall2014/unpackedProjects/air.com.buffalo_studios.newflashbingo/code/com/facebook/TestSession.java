...
public class TestSession extends Session
{
    ...
    private static TestSession createTestSession(final Activity activity, final List<String> list, final TestSession$Mode testSession$Mode, final String s) {
    ...
    private static void retrieveTestAccountsForAppIfNeeded() {
        while (true) {
            ...
            final GraphObjectList<TestSession$FqlResult> data = response2.getGraphObjectAs(TestSession$FqlResponse.class).getData();
