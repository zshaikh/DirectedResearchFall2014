...
public final class AccessToken implements Serializable
{
    ...
    public static AccessToken createFromExistingAccessToken(final String s, final Date date, final Date date2, final AccessTokenSource accessTokenSource, final List<String> list) {
