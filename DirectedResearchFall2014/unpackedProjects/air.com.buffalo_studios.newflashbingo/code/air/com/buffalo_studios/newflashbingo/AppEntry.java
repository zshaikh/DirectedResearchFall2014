...
public class AppEntry extends Activity
{
    ...
    private static final String RESOURCE_CLASS = "air.com.buffalo_studios.newflashbingo.R";
    ...
    private void showRuntimeNotInstalledDialog() {
        final ResourceIdMap resourceIdMap = new ResourceIdMap("air.com.buffalo_studios.newflashbingo.R");
