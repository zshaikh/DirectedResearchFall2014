...
final class z implements ad<Object>
{
    final int a;
    final Bundle b;
    x<Object> c;
    ...
    public z(final y o, final int c) {
        this.o = o;
        super();
        this.a = 0;
        this.b = null;
    ...
    @Override
    public final void a(final ac<Object> ac, final Object g) {
        if (y.a) {
    ...
    final void b(final ac<Object> obj, final Object o) {
        if (this.c == null) {
            return;
        }
        final j e = this.o.e;
