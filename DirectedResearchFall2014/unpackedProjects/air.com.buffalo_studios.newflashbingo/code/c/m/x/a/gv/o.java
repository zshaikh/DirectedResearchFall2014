...
final class o extends n
{
    ...
    private void a(final RuntimeException ex) {
        ...
        final PrintWriter printWriter = new PrintWriter(new am("FragmentManager"));
        while (true) {
            Label_0079: {
                if (this.o == null) {
                    break Label_0079;
    ...
    private void c(final e e) {
        if (e.mInnerView != null) {
            ...
            e.mInnerView.saveHierarchyState((SparseArray)this.x);
            if (this.x.size() > 0) {
    ...
    final void a(final Parcelable parcelable, final ArrayList<e> list) {
        if (parcelable != null) {
            ...
            if (r.a != null) {
                if (list != null) {
                    for (int i = 0; i < list.size(); ++i) {
                        ...
                        if (t.j != null) {
                            ...
                            e.mSavedViewState = (SparseArray<Parcelable>)t.j.getSparseParcelableArray("android:view_state");
                        }
                    }
                }
                this.f = new ArrayList<e>(r.a.length);
                if (this.h != null) {
                    this.h.clear();
                }
                    ...
                    for (int k = 0; k < list.size(); ++k) {
                        ...
                        if (obj.mTargetIndex >= 0) {
                            if (obj.mTargetIndex < this.f.size()) {
                                obj.mTarget = this.f.get(obj.mTargetIndex);
                            }
                            else {
                ...
                if (r.b != null) {
                    this.g = new ArrayList<e>(r.b.length);
            ...
            if (obj != null) {
                ...
                if (obj.mState > 0 && t.j == null) {
                    ...
                    if (obj.mSavedViewState != null) {
                        ...
                        w.putSparseParcelableArray("android:view_state", (SparseArray)obj.mSavedViewState);
                    }
