...
public class FBOpenParticularFriendFeedDialogFunction implements FREFunction
{
    @Override
    public FREObject call(final FREContext context, final FREObject[] array) {
        try {
            ...
            final String asString10 = array[9].getAsString();
            FacebookExtContext.updateFBSession(asString, array[10].getAsString(), asString2);
            final HashMap<String, String> hashMap = new HashMap<String, String>();
            hashMap.put("name", asString3);
            hashMap.put("link", asString4);
            final Bundle bundle = new Bundle();
            bundle.putString("to", asString10);
