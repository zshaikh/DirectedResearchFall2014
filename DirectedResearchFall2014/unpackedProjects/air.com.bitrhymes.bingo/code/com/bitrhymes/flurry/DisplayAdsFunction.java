...
public class DisplayAdsFunction implements FREFunction
{
    @Override
    public FREObject call(final FREContext freContext, final FREObject[] array) {
        try {
            ...
            FlurryAds.displayAd((Context)freContext.getActivity(), asString, (ViewGroup)freContext.getActivity().getWindow().getDecorView().getRootView());
            Log.i(this.getClass().getSimpleName(), "displayad-" + asString);
            return null;
        }
