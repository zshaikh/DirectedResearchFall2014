...
public class LoginActivity extends Activity
{
    ...
    public void onCreate(final Bundle bundle) {
        ...
        this.setContentView(FacebookExt.context.getResourceId("layout.com_facebook_login_activity_layout"));
        if (bundle != null) {
        ...
        this.authorizationClient.setBackgroundProcessingListener((AuthorizationClient.BackgroundProcessingListener)new AuthorizationClient.BackgroundProcessingListener() {
            ...
            public void onBackgroundProcessingStarted() {
                LoginActivity.this.findViewById(FacebookExt.context.getResourceId("id.com_facebook_login_activity_progress_bar")).setVisibility(0);
            }
            
            @Override
            public void onBackgroundProcessingStopped() {
                LoginActivity.this.findViewById(FacebookExt.context.getResourceId("id.com_facebook_login_activity_progress_bar")).setVisibility(8);
            }
        });
    }
    ...
    public void onPause() {
        ...
        this.findViewById(FacebookExt.context.getResourceId("id.com_facebook_login_activity_progress_bar")).setVisibility(8);
    }
