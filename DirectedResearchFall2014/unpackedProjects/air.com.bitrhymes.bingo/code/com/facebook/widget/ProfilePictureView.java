...
public class ProfilePictureView extends FrameLayout
{
    ...
    private int getPresetSizeInPixels(final boolean b) {
        ...
        switch (this.presetSizeType) {
            ...
            case -2: {
                n = FacebookExt.context.getResourceId("dimen.com_facebook_profilepictureview_preset_size_small");
                break;
            }
            case -3: {
                n = FacebookExt.context.getResourceId("dimen.com_facebook_profilepictureview_preset_size_normal");
                break;
            }
            case -4: {
                n = FacebookExt.context.getResourceId("dimen.com_facebook_profilepictureview_preset_size_large");
                break;
            }
            case -1: {
                if (!b) {
    ...
    private void setBlankProfilePicture() {
        if (this.customizedDefaultProfilePicture == null) {
            int n;
            if (this.isCropped()) {
                n = FacebookExt.context.getResourceId("drawable.com_facebook_profile_picture_blank_square");
            }
            else {
                n = FacebookExt.context.getResourceId("drawable.com_facebook_profile_picture_blank_portrait");
            }
    ...
    private boolean updateImageQueryParameters() {
        ...
        final boolean b = width != this.queryWidth || height != this.queryHeight;
