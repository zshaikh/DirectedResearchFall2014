...
public class UserSettingsFragment extends FacebookFragment
{
    ...
    private ImageRequest getImageRequest() {
        try {
            return new ImageRequest.Builder((Context)this.getActivity(), ImageRequest.getProfilePictureUrl(this.user.getId(), this.getResources().getDimensionPixelSize(FacebookExt.context.getResourceId("dimen.com_facebook_usersettingsfragment_profile_picture_width")), this.getResources().getDimensionPixelSize(FacebookExt.context.getResourceId("dimen.com_facebook_usersettingsfragment_profile_picture_height")))).setCallerTag(this).setCallback(new ImageRequest.Callback() {
                @Override
    ...
    private void processImageResponse(final String userProfilePicID, final ImageResponse imageResponse) {
        if (imageResponse != null) {
            ...
            if (bitmap != null) {
                ...
                userProfilePic.setBounds(0, 0, this.getResources().getDimensionPixelSize(FacebookExt.context.getResourceId("dimen.com_facebook_usersettingsfragment_profile_picture_width")), this.getResources().getDimensionPixelSize(FacebookExt.context.getResourceId("dimen.com_facebook_usersettingsfragment_profile_picture_height")));
    ...
    private void updateUI() {
        ...
        if (!this.isSessionOpen()) {
            final int color = this.getResources().getColor(FacebookExt.context.getResourceId("color.com_facebook_usersettingsfragment_not_connected_text_color"));
            this.connectedStateLabel.setTextColor(color);
            this.connectedStateLabel.setShadowLayer(0.0f, 0.0f, 0.0f, color);
            this.connectedStateLabel.setText((CharSequence)this.getResources().getString(FacebookExt.context.getResourceId("string.com_facebook_usersettingsfragment_not_logged_in")));
        ...
        this.connectedStateLabel.setTextColor(this.getResources().getColor(FacebookExt.context.getResourceId("color.com_facebook_usersettingsfragment_connected_text_color")));
        this.connectedStateLabel.setShadowLayer(1.0f, 0.0f, -1.0f, this.getResources().getColor(FacebookExt.context.getResourceId("color.com_facebook_usersettingsfragment_connected_shadow_color")));
        if (this.user != null) {
        ...
        this.connectedStateLabel.setText((CharSequence)this.getResources().getString(FacebookExt.context.getResourceId("string.com_facebook_usersettingsfragment_logged_in")));
        final Drawable drawable = this.getResources().getDrawable(FacebookExt.context.getResourceId("drawable.com_facebook_profile_default_icon"));
        drawable.setBounds(0, 0, this.getResources().getDimensionPixelSize(FacebookExt.context.getResourceId("dimen.com_facebook_usersettingsfragment_profile_picture_width")), this.getResources().getDimensionPixelSize(FacebookExt.context.getResourceId("dimen.com_facebook_usersettingsfragment_profile_picture_height")));
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        final View inflate = layoutInflater.inflate(FacebookExt.context.getResourceId("layout.com_facebook_usersettingsfragment"), viewGroup, false);
        (this.loginButton = (LoginButton)inflate.findViewById(FacebookExt.context.getResourceId("id.com_facebook_usersettingsfragment_login_button"))).setProperties(this.loginButtonProperties);
        ...
        this.connectedStateLabel = (TextView)inflate.findViewById(FacebookExt.context.getResourceId("id.com_facebook_usersettingsfragment_profile_name"));
        if (inflate.getBackground() == null) {
            inflate.setBackgroundColor(this.getResources().getColor(FacebookExt.context.getResourceId("color.com_facebook_blue")));
            return inflate;
        }
