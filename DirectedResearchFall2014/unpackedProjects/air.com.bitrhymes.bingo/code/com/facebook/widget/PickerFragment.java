...
public abstract class PickerFragment<T extends GraphObject> extends Fragment
{
    ...
    private void inflateTitleBar(final ViewGroup viewGroup) {
        final ViewStub viewStub = (ViewStub)viewGroup.findViewById(FacebookExt.context.getResourceId("id.com_facebook_picker_title_bar_stub"));
        if (viewStub != null) {
            final View inflate = viewStub.inflate();
            final RelativeLayout$LayoutParams layoutParams = new RelativeLayout$LayoutParams(-1, -1);
            layoutParams.addRule(3, FacebookExt.context.getResourceId("id.com_facebook_picker_title_bar"));
            ...
            this.doneButton = (Button)viewGroup.findViewById(FacebookExt.context.getResourceId("id.com_facebook_picker_done_button"));
            ...
            this.titleTextView = (TextView)viewGroup.findViewById(FacebookExt.context.getResourceId("id.com_facebook_picker_title"));
    ...
    String getDefaultDoneButtonText() {
        return this.getString(FacebookExt.context.getResourceId("string.com_facebook_picker_done_button_text"));
    }
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        ...
        (this.listView = (ListView)viewGroup2.findViewById(FacebookExt.context.getResourceId("id.com_facebook_picker_list_view"))).setOnItemClickListener((AdapterView$OnItemClickListener)new AdapterView$OnItemClickListener() {
        ...
        this.activityCircle = (ProgressBar)viewGroup2.findViewById(FacebookExt.context.getResourceId("id.com_facebook_picker_activity_circle"));
