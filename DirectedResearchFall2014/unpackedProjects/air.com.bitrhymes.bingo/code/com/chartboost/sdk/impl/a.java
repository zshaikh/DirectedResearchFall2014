...
public class a
{
    ...
    public a(final JSONObject jsonObject, final c d, final a g, final b c, final String e, final boolean l) {
        super();
        JSONObject a;
        if (jsonObject == null) {
            a = new JSONObject();
        ...
        this.f.c = (com.chartboost.sdk.c.a)new com.chartboost.sdk.c.a() {
            @Override
            public void a() {
        ...
        this.f.a = (com.chartboost.sdk.c.a)new com.chartboost.sdk.c.a() {
            @Override
            public void a() {
                if (com.chartboost.sdk.impl.a.this.g != null) {
        ...
        this.f.b = (com.chartboost.sdk.c.c)new com.chartboost.sdk.c.c() {
            @Override
        ...
        this.f.d = (com.chartboost.sdk.c.a)new com.chartboost.sdk.c.a() {
            @Override
            public void a() {
                if (com.chartboost.sdk.impl.a.this.g != null) {
