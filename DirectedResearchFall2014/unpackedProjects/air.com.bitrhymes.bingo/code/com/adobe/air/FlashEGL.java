...
public class FlashEGL
{
    ...
    public int CreateDummySurfaceAndContext() {
        ...
        this.mEgl.eglChooseConfig(this.mEglDisplay, FlashEGL.cfgAttrs, array2, 1, array);
        FlashEGL.cfgAttrs[1] = -1;
        if (array[0] == 0) {
            return 12294;
        }
    ...
    public int[] GetConfigs(final boolean b, final boolean b2) {
        ...
        this.mEgl.eglChooseConfig(this.mEglDisplay, FlashEGL.cfgAttrs, this.mEglConfigList, this.mEglConfigCount, array2);
    ...
    public int[] GetNumConfigs() {
        ...
        final int[] array2 = { 0 };
        this.mEgl.eglChooseConfig(this.mEglDisplay, FlashEGL.cfgAttrs, (EGLConfig[])null, 0, array2);
        final int mEglConfigCount = array2[0];
