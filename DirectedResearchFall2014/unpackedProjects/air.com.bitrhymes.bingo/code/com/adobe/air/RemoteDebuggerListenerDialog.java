...
public class RemoteDebuggerListenerDialog extends Activity
{
    ...
    public void onCreate(final Bundle bundle) {
        final String string = this.getString(2131099676);
        final String string2 = this.getString(2131099677);
        ...
        this.mWaitDialog = this.createDialog(this.getString(2131099674), format, this.getString(2131099654), (DialogInterface$OnClickListener)new DialogInterface$OnClickListener() {
        ...
        this.mCheckAgain = new Runnable() {
            ...
            public void run() {
                ...
                RemoteDebuggerListenerDialog.this.mWaitDialog = RemoteDebuggerListenerDialog.this.createDialog("Adobe AIR", string2, RemoteDebuggerListenerDialog.this.getString(2131099655), (DialogInterface$OnClickListener)dialogInterface$OnClickListener, (DialogInterface$OnKeyListener)new DialogInterface$OnKeyListener() {
                    public boolean onKey(final DialogInterface dialogInterface, final int n, final KeyEvent keyEvent) {
                        if (n == 4) {
