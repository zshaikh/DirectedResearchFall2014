...
public class Browser extends Activity
{
    ...
    private Bitmap bitmapFromBase64(final String s) {
        final byte[] decode = Base64.decode(s, 0);
        return BitmapFactory.decodeByteArray(decode, 0, decode.length);
    }
    
    private Bitmap getDensityScaledBitmap(final String s) {
        final DisplayMetrics displayMetrics = new DisplayMetrics();
        this.getWindowManager().getDefaultDisplay().getMetrics(displayMetrics);
        Bitmap bitmap = this.bitmapFromBase64(s);
        if (bitmap != null) {
    ...
    public Bitmap bitmapFromJar(final String p0) {
        ...
        //    11: invokevirtual   java/net/URL.getFile:()Ljava/lang/String;
        //    14: astore          7
        //    16: aload           7
        //    18: ldc             "file:"
        ...
        //    50: iconst_0       
        //    51: iload           8
        //    53: invokevirtual   java/lang/String.substring:(II)Ljava/lang/String;
        //    56: astore          7
        //    58: new             Ljava/util/jar/JarFile;
        //    61: dup            
        //    62: aload           7
        //    64: invokespecial   java/util/jar/JarFile.<init>:(Ljava/lang/String;)V
        //    67: astore          9
        //    69: aload           9
        //    71: aload           9
        //    73: aload_1        
        //    74: invokevirtual   java/util/jar/JarFile.getJarEntry:(Ljava/lang/String;)Ljava/util/jar/JarEntry;
        //    77: invokevirtual   java/util/jar/JarFile.getInputStream:(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
        //    80: astore_2       
        //    81: aload_2        
        //    82: invokestatic    android/graphics/BitmapFactory.decodeStream:(Ljava/io/InputStream;)Landroid/graphics/Bitmap;
        //    85: astore          10
        //    87: aload_2        
        //    88: ifnull          95
        //    91: aload_2        
        ...
        //  -----  -----  -----  -----  ---------------------
        //  2      34     98     115    Ljava/lang/Exception;
        //  2      34     115    126    Any
        //  34     43     98     115    Ljava/lang/Exception;
        //  34     43     115    126    Any
        //  48     58     98     115    Ljava/lang/Exception;
        //  48     58     115    126    Any
        //  58     87     98     115    Ljava/lang/Exception;
        //  58     87     115    126    Any
        //  91     95     126    131    Ljava/lang/Exception;
        //  100    105    115    126    Any
        //  109    113    131    136    Ljava/lang/Exception;
        //  120    124    136    141    Ljava/lang/Exception;
        // 
    ...
    public void onCreate(final Bundle bundle) {
        ...
        linearLayout.setBackgroundDrawable((Drawable)new BitmapDrawable(this.getDensityScaledBitmap("iVBORw0KGgoAAAANSUhEUgAAAAEAAAAsCAIAAAArRUU2AAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJ\nbWFnZVJlYWR5ccllPAAAAEFJREFUeNpicPP0Zvr3/z/T/3//gDQQg+i//5j+gum/QBqIQXwg+x+Y\njckH6fkL0/f3NwMPHz8jKxsbAw0AQIABAGYHPKslk98oAAAAAElFTkSuQmCC")));
        ...
        imageButton.setImageBitmap(this.getDensityScaledBitmap(""));
        ...
        imageButton3.setImageBitmap(this.getDensityScaledBitmap(""));
        ...
        webView.setWebViewClient((WebViewClient)new WebViewClient() {
            public void onPageFinished(final WebView webView, final String str) {
                ...
                if (webView.canGoForward()) {
                    imageButton.setImageBitmap(Browser.this.getDensityScaledBitmap("\nzzOMcSXw5OSESqUS1ft5/C3AAL39YeI2ufApAAAAAElFTkSuQmCC"));
                    return;
                }
                imageButton.setImageBitmap(Browser.this.getDensityScaledBitmap(""));
            }
