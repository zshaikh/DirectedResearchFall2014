...
public class TapjoyConstants
{
    ...
    public static final String TJC_BRIDGE_VERSION_NUMBER = "1.0.4";
    ...
    public static final int TJC_LIBRARY_VERSION_INT = 911;
    public static final String TJC_LIBRARY_VERSION_NUMBER = "9.1.1";
    ...
    static {
        dependencyClassNames = new String[] { "com.tapjoy.TJCOffersWebView", "com.tapjoy.TapjoyFullScreenAdWebView", "com.tapjoy.TapjoyVideoView", "com.tapjoy.TJAdUnitView", "com.tapjoy.mraid.view.ActionHandler", "com.tapjoy.mraid.view.Browser" };
        dependencyPermissions = new String[] { "android.permission.INTERNET", "android.permission.ACCESS_NETWORK_STATE" };
        optionalPermissions = new String[] { "android.permission.ACCESS_FINE_LOCATION", "android.permission.ACCESS_COARSE_LOCATION", "android.permission.READ_PHONE_STATE", "android.permission.ACCESS_WIFI_STATE" };
    }
}
