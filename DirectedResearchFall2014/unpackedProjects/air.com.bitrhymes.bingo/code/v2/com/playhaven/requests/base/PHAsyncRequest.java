...
public class PHAsyncRequest extends AsyncTask<Uri, Integer, ByteBuffer>
{
    ...
    public static class PHHttpConn
    {
        ...
        public PHHttpConn() {
            ...
            (this.client = new DefaultHttpClient(this.enableRedirecting(null))).setRedirectHandler((RedirectHandler)new PHRedirectHandler());
        }
        ...
        public HttpResponse start(final HttpUriRequest cur_request) throws IOException {
            ...
            if (this.username != null && this.password != null) {
                cur_request.setHeader("Authorization", String.format("Basic %s", Base64.encodeToString((this.username + ":" + this.password).getBytes(), 10)));
            }
