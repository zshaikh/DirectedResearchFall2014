...
.method public initLayout(Landroid/content/Context;)V
    ...
    .line 34
    iget-object v1, p0, Lcom/flurry/android/e;->g:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/jumptap/adtag/JtAdWidgetSettings;->setPublisherId(Ljava/lang/String;)V

    .line 36
    invoke-virtual {v0, v2}, Lcom/jumptap/adtag/JtAdWidgetSettings;->setRefreshPeriod(I)V

    .line 38
    invoke-virtual {v0, v2}, Lcom/jumptap/adtag/JtAdWidgetSettings;->setShouldSendLocation(Z)V

    .line 40
    const/16 v1, 0x11

    invoke-virtual {p0, v1}, Lcom/flurry/android/e;->setGravity(I)V
    ...
    invoke-direct {v2, p1, v0}, Lcom/jumptap/adtag/JtAdView;-><init>(Landroid/content/Context;Lcom/jumptap/adtag/JtAdWidgetSettings;)V
    :try_end_0
