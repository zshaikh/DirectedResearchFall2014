...
.method private loadParameters()V
    ...
    iput-object v2, p0, Lcom/google/analytics/tracking/android/EasyTracker;->mTrackingId:Ljava/lang/String;

    .line 233
    iget-object v2, p0, Lcom/google/analytics/tracking/android/EasyTracker;->mTrackingId:Ljava/lang/String;
    ...
    .line 243
    :cond_1
    iput-boolean v6, p0, Lcom/google/analytics/tracking/android/EasyTracker;->mIsEnabled:Z
    ...
    iput-object v2, p0, Lcom/google/analytics/tracking/android/EasyTracker;->mAppName:Ljava/lang/String;
    ...
    iput-object v2, p0, Lcom/google/analytics/tracking/android/EasyTracker;->mAppVersion:Ljava/lang/String;

    .line 246
    iget-object v2, p0, Lcom/google/analytics/tracking/android/EasyTracker;->mParameterFetcher:Lcom/google/analytics/tracking/android/ParameterLoader;

    const-string v3, "ga_debug"

    invoke-interface {v2, v3}, Lcom/google/analytics/tracking/android/ParameterLoader;->getBoolean(Ljava/lang/String;)Z

    move-result v2

    iput-boolean v2, p0, Lcom/google/analytics/tracking/android/EasyTracker;->mDebug:Z

    .line 248
    iget-object v2, p0, Lcom/google/analytics/tracking/android/EasyTracker;->mParameterFetcher:Lcom/google/analytics/tracking/android/ParameterLoader;

    const-string v3, "ga_sampleFrequency"

    invoke-interface {v2, v3}, Lcom/google/analytics/tracking/android/ParameterLoader;->getDoubleFromString(Ljava/lang/String;)Ljava/lang/Double;

    move-result-object v2

    iput-object v2, p0, Lcom/google/analytics/tracking/android/EasyTracker;->mSampleRate:Ljava/lang/Double;

    .line 249
    iget-object v2, p0, Lcom/google/analytics/tracking/android/EasyTracker;->mSampleRate:Ljava/lang/Double;
    ...
    const-string v3, "ga_dispatchPeriod"
    ...
    iput v2, p0, Lcom/google/analytics/tracking/android/EasyTracker;->mDispatchPeriod:I

    .line 253
    iget-object v2, p0, Lcom/google/analytics/tracking/android/EasyTracker;->mParameterFetcher:Lcom/google/analytics/tracking/android/ParameterLoader;

    const-string v3, "ga_sessionTimeout"
    ...
    const-string v3, "ga_autoActivityTracking"
    ...
    const-string v3, "ga_auto_activity_tracking"
