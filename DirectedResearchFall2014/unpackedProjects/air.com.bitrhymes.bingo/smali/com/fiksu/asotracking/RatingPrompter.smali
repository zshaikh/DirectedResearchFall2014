...
.method private enoughTimeSinceFirstLaunch(Landroid/content/SharedPreferences;Landroid/content/SharedPreferences$Editor;)Z
    ...
    invoke-interface {p1, v8, v4, v5}, Landroid/content/SharedPreferences;->getLong(Ljava/lang/String;J)J
    ...
    invoke-interface {p2, v8, v4, v5}, Landroid/content/SharedPreferences$Editor;->putLong(Ljava/lang/String;J)Landroid/content/SharedPreferences$Editor;
...
.method private shouldPrompt()Z
    ...
    .line 128
    iget-object v4, p0, Lcom/fiksu/asotracking/RatingPrompter;->mAppName:Ljava/lang/String;
    ...
    const-string v5, "Fiksu.ratingsDictionary"
...
.method public maybeShowPrompt()V
    ...
    .line 164
    const-string v1, "If so, please rate it in Google Play.  It takes less than a minute and we appreciate your support!"
